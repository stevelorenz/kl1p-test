...
# get csv data
mean_array_amp = np.array(list(csv.reader(open("../../../test_results/sensing_matrix_kl1p/pc/snr_10db/MSEMean_AMP_10db.csv", "r"), delimiter=','))).astype('float')
std_array_amp = np.array(list(csv.reader(open("../../../test_results/sensing_matrix_kl1p/pc/snr_10db/MSEStd_AMP_10db.csv", "r"), delimiter=','))).astype('float')

# get csv data
mean_array_bp = np.array(list(csv.reader(open("../../../test_results/sensing_matrix_kl1p/pc/snr_10db/MSEMean_Basis-Pursuit_10db.csv", "r"), delimiter=','))).astype('float')
std_array_bp = np.array(list(csv.reader(open("../../../test_results/sensing_matrix_kl1p/pc/snr_10db/MSEStd_Basis-Pursuit_10db.csv", "r"), delimiter=','))).astype('float')
...
plt.suptitle("MSE with SNR=10db")
...
# save picture
plt.savefig('mse_10db.png', dpi=300)
