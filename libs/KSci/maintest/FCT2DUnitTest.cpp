...
KFCT2DUnitTest::KFCT2DUnitTest() : Test::Suite()
{
    TEST_ADD(KFCT2DUnitTest::testDefaultConstructor)  
    TEST_ADD(KFCT2DUnitTest::testCopyConstructor)
    TEST_ADD(KFCT2DUnitTest::testAffectationOperator)

    TEST_ADD(KFCT2DUnitTest::testTransform)
    TEST_ADD(KFCT2DUnitTest::testTransform_02)
    TEST_ADD(KFCT2DUnitTest::testTransform_03)
    TEST_ADD(KFCT2DUnitTest::testTransform_04)
    TEST_ADD(KFCT2DUnitTest::testTransform_Complex)
    TEST_ADD(KFCT2DUnitTest::testInvert)   
    TEST_ADD(KFCT2DUnitTest::testInvert_02) 
    TEST_ADD(KFCT2DUnitTest::testInvert_03) 
    TEST_ADD(KFCT2DUnitTest::testInvert_04) 
    TEST_ADD(KFCT2DUnitTest::testInvert_Complex)  
}

// ---------------------------------------------------------------------------------------------------- //

KFCT2DUnitTest::~KFCT2DUnitTest()
{}

// ---------------------------------------------------------------------------------------------------- //

void KFCT2DUnitTest::testDefaultConstructor()
{
    try
    {
        TFCT2D<klab::DoubleReal> fct;
        TEST_ASSERT(true)

        TFCT2D<std::complex<klab::DoubleReal> > cfct;
        TEST_ASSERT(true)
    }
    catch(...)
    {
...
void KFCT2DUnitTest::testCopyConstructor()
{
    try
    {
        TFCT2D<klab::DoubleReal> fct;
        TFCT2D<klab::DoubleReal> fctCopy(fct);
        TEST_ASSERT(true)

        TFCT2D<std::complex<klab::DoubleReal> > cfct;
        TFCT2D<std::complex<klab::DoubleReal> > cfctCopy(cfct);
        TEST_ASSERT(true)
    }
    catch(...)
    {
...
void KFCT2DUnitTest::testAffectationOperator()
{
    try
    {
        TFCT2D<klab::DoubleReal> fct;
        TFCT2D<klab::DoubleReal> fctCopy; 
        fctCopy = fct;
        TEST_ASSERT(true)

        TFCT2D<std::complex<klab::DoubleReal> > cfct;
        TFCT2D<std::complex<klab::DoubleReal> > cfctCopy;
        cfctCopy = cfct;
        TEST_ASSERT(true)
    }
    catch(...)
...
void KFCT2DUnitTest::testTransform()
{
    try
    {
        klab::UInt32 m = 8;
        ...
        // Limit cases.
        fct.transform(arma::Mat<klab::DoubleReal>(), F);
        TEST_ASSERT(F.n_rows==0 && F.n_cols==0)

        fct.transform(arma::Mat<klab::DoubleReal>(8, 0), F);
        TEST_ASSERT(F.n_rows==8 && F.n_cols==0)

        fct.transform(arma::Mat<klab::DoubleReal>(0, 8), F);
...
void KFCT2DUnitTest::testTransform_02()
{
    try
    {
        klab::UInt32 m = 8;
        ...
        fct.transform(arma::Mat<klab::DoubleReal>(0, 7), F);
...
void KFCT2DUnitTest::testTransform_03()
{
    try
    {
        klab::UInt32 m = 7;
        ...
        fct.transform(arma::Mat<klab::DoubleReal>(7, 0), F);
...
void KFCT2DUnitTest::testTransform_04()
{
    try
    {
        klab::UInt32 m = 7;
...
void KFCT2DUnitTest::testTransform_Complex()
{
    try
    {
        klab::UInt32 m = 8;
        ...
        TFCT2D<std::complex<klab::DoubleReal> > fct;
        ...
        // Limit cases.
        fct.transform(arma::Mat<std::complex<klab::DoubleReal> >(), F);
        TEST_ASSERT(F.n_rows==0 && F.n_cols==0)

        fct.transform(arma::Mat<std::complex<klab::DoubleReal> >(8, 0), F);
        TEST_ASSERT(F.n_rows==8 && F.n_cols==0)

        fct.transform(arma::Mat<std::complex<klab::DoubleReal> >(0, 8), F);
        TEST_ASSERT(F.n_rows==0 && F.n_cols==8)
    }
    catch(...)
    {
...
void KFCT2DUnitTest::testInvert()
{
    try
    {
        klab::UInt32 m = 8;
        ...
        // Limit cases.
        fct.invert(arma::Mat<klab::DoubleReal>(), F);
        TEST_ASSERT(F.n_rows==0 && F.n_cols==0)

        fct.invert(arma::Mat<klab::DoubleReal>(8, 0), F);
        TEST_ASSERT(F.n_rows==8 && F.n_cols==0)

        fct.invert(arma::Mat<klab::DoubleReal>(0, 8), F);
        TEST_ASSERT(F.n_rows==0 && F.n_cols==8)
    }
    catch(...)
    {
...
void KFCT2DUnitTest::testInvert_02()
{
    try
    {
        klab::UInt32 m = 8;
        ...
        fct.invert(arma::Mat<klab::DoubleReal>(0, 7), F);
        TEST_ASSERT(F.n_rows==0 && F.n_cols==7)
    }
    catch(...)
    {
...
void KFCT2DUnitTest::testInvert_03()
{
    try
    {
        klab::UInt32 m = 7;
        ...
        fct.invert(arma::Mat<klab::DoubleReal>(7, 0), F);
        TEST_ASSERT(F.n_rows==7 && F.n_cols==0)
...
void KFCT2DUnitTest::testInvert_04()
{
    try
    {
        klab::UInt32 m = 7;
...
void KFCT2DUnitTest::testInvert_Complex()
{
    try
    {
        klab::UInt32 m = 8;
        ...
        // Limit cases.
        fct.invert(arma::Mat<std::complex<klab::DoubleReal> >(), F);
        TEST_ASSERT(F.n_rows==0 && F.n_cols==0)

        fct.invert(arma::Mat<std::complex<klab::DoubleReal> >(8, 0), F);
        TEST_ASSERT(F.n_rows==8 && F.n_cols==0)

        fct.invert(arma::Mat<std::complex<klab::DoubleReal> >(0, 8), F);
        TEST_ASSERT(F.n_rows==0 && F.n_cols==8)
    }
    catch(...)
    {
