...
KFWT2DUnitTest::KFWT2DUnitTest() : Test::Suite()
{
    TEST_ADD(KFWT2DUnitTest::testDefaultConstructor)  
    TEST_ADD(KFWT2DUnitTest::testFilterConstructor)
    TEST_ADD(KFWT2DUnitTest::testCopyConstructor)
    TEST_ADD(KFWT2DUnitTest::testAffectationOperator)

    TEST_ADD(KFWT2DUnitTest::testFilter)
    TEST_ADD(KFWT2DUnitTest::testTransform)
    TEST_ADD(KFWT2DUnitTest::testTransform_02)
    TEST_ADD(KFWT2DUnitTest::testTransform_03)
    TEST_ADD(KFWT2DUnitTest::testInvert)   
    TEST_ADD(KFWT2DUnitTest::testInvert_02)   
    TEST_ADD(KFWT2DUnitTest::testInvert_03)   

    TEST_ADD(KFWT2DUnitTest::testHaarWavelet)
    TEST_ADD(KFWT2DUnitTest::testDaubechies2Wavelet) 
    TEST_ADD(KFWT2DUnitTest::testDaubechies4Wavelet) 
    TEST_ADD(KFWT2DUnitTest::testDaubechies6Wavelet)
    TEST_ADD(KFWT2DUnitTest::testDaubechies8Wavelet)
    TEST_ADD(KFWT2DUnitTest::testDaubechies10Wavelet)
    TEST_ADD(KFWT2DUnitTest::testDaubechies9_7Wavelet)
    TEST_ADD(KFWT2DUnitTest::testDelegateWavelet)
    TEST_ADD(KFWT2DUnitTest::testNameWavelet)
    TEST_ADD(KFWT2DUnitTest::testCustomWavelet)
}

// ---------------------------------------------------------------------------------------------------- //

KFWT2DUnitTest::~KFWT2DUnitTest()
{}

// ---------------------------------------------------------------------------------------------------- //

void KFWT2DUnitTest::testDefaultConstructor()
{
    try
    {
        TFWT2D<klab::DoubleReal> fwt;
...
void KFWT2DUnitTest::testFilterConstructor()
{
    try
    {
        THaarWaveletFilter<klab::DoubleReal> filter;

        TFWT2D<klab::DoubleReal, THaarWaveletFilter<klab::DoubleReal> > fwt(filter);
...
void KFWT2DUnitTest::testCopyConstructor()
{
    try
    {
        TFWT2D<klab::DoubleReal> fwt;
        ...
        TFWT2D<klab::DoubleReal> fwt2(fwt);
...
void KFWT2DUnitTest::testAffectationOperator()
{
    try
    {
        TFWT2D<klab::DoubleReal> fwt;
...
void KFWT2DUnitTest::testFilter()
{
    try
    {
        TFWT2D<klab::DoubleReal> fwt;
...
void KFWT2DUnitTest::testTransform()
{
    try
    {
        klab::UInt32 m = 8;
        ...
        TFWT2D<klab::DoubleReal, THaarWaveletFilter<klab::DoubleReal> > fwt;
        ...
        // Limit cases.
        fwt.transform(arma::Mat<klab::DoubleReal>(), F);
        TEST_ASSERT(F.n_rows==0 && F.n_cols==0)

        try                                 {fwt.transform(arma::Mat<klab::DoubleReal>(7, 8), F); TEST_ASSERT(false)}
        catch(KSizePowerOf2FWTException&)   {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}

        try                                 {fwt.transform(arma::Mat<klab::DoubleReal>(8, 7), F); TEST_ASSERT(false)}
        catch(KSizePowerOf2FWTException&)   {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}

        try                                 {fwt.transform(arma::Mat<klab::DoubleReal>(7, 7), F); TEST_ASSERT(false)}
        catch(KSizePowerOf2FWTException&)   {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}
...
void KFWT2DUnitTest::testTransform_02()
{
    try
    {
        klab::UInt32 m = 8;
        ...
        try                                 {fwt.transform(arma::Mat<klab::DoubleReal>(8, 3), F); TEST_ASSERT(false)}
        catch(KSizePowerOf2FWTException&)   {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}

        try                                 {fwt.transform(arma::Mat<klab::DoubleReal>(7, 4), F); TEST_ASSERT(false)}
        catch(KSizePowerOf2FWTException&)   {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}

        try                                 {fwt.transform(arma::Mat<klab::DoubleReal>(7, 3), F); TEST_ASSERT(false)}
        catch(KSizePowerOf2FWTException&)   {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}
...
void KFWT2DUnitTest::testTransform_03()
{
    try
    {
        klab::UInt32 m = 4;
        ...
        try                                 {fwt.transform(arma::Mat<klab::DoubleReal>(3, 8), F); TEST_ASSERT(false)}
        catch(KSizePowerOf2FWTException&)   {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}

        try                                 {fwt.transform(arma::Mat<klab::DoubleReal>(4, 7), F); TEST_ASSERT(false)}
        catch(KSizePowerOf2FWTException&)   {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}

        try                                 {fwt.transform(arma::Mat<klab::DoubleReal>(3, 7), F); TEST_ASSERT(false)}
        catch(KSizePowerOf2FWTException&)   {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}
...
void KFWT2DUnitTest::testInvert()
{
    try
    {
        klab::UInt32 m = 8;
        ...
        // Limit cases.
        fwt.invert(arma::Mat<klab::DoubleReal>(), fR);
        TEST_ASSERT(fR.n_rows==0 && fR.n_cols==0)

        try                                 {fwt.invert(arma::Mat<klab::DoubleReal>(7, 8), fR); TEST_ASSERT(false)}
        catch(KSizePowerOf2FWTException&)   {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}

        try                                 {fwt.invert(arma::Mat<klab::DoubleReal>(8, 7), fR); TEST_ASSERT(false)}
        catch(KSizePowerOf2FWTException&)   {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}

        try                                 {fwt.invert(arma::Mat<klab::DoubleReal>(7, 7), fR); TEST_ASSERT(false)}
        catch(KSizePowerOf2FWTException&)   {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}
...
void KFWT2DUnitTest::testInvert_02()
{
    try
    {
        klab::UInt32 m = 8;
        ...
        try                                 {fwt.invert(arma::Mat<klab::DoubleReal>(7, 4), fR); TEST_ASSERT(false)}
        catch(KSizePowerOf2FWTException&)   {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}

        try                                 {fwt.invert(arma::Mat<klab::DoubleReal>(8, 3), fR); TEST_ASSERT(false)}
        catch(KSizePowerOf2FWTException&)   {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}

        try                                 {fwt.invert(arma::Mat<klab::DoubleReal>(7, 3), fR); TEST_ASSERT(false)}
        catch(KSizePowerOf2FWTException&)   {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}
...
void KFWT2DUnitTest::testInvert_03()
{
    try
    {
        klab::UInt32 m = 4;
        ...
        try                                 {fwt.invert(arma::Mat<klab::DoubleReal>(3, 8), fR); TEST_ASSERT(false)}
        catch(KSizePowerOf2FWTException&)   {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}

        try                                 {fwt.invert(arma::Mat<klab::DoubleReal>(4, 7), fR); TEST_ASSERT(false)}
        catch(KSizePowerOf2FWTException&)   {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}

        try                                 {fwt.invert(arma::Mat<klab::DoubleReal>(3, 7), fR); TEST_ASSERT(false)}
        catch(KSizePowerOf2FWTException&)   {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}
...
void KFWT2DUnitTest::testHaarWavelet()
{
    try
    {
        klab::UInt32 m = 8;
...
void KFWT2DUnitTest::testDaubechies2Wavelet()
{
    try
    {
        klab::UInt32 m = 8;
        ...
        TFWT2D<klab::DoubleReal, TDaubechiesWaveletFilter<klab::DoubleReal, 2> > fwt;
...
void KFWT2DUnitTest::testDaubechies4Wavelet()
{
    try
    {
        klab::UInt32 m = 8;
        ...
        TFWT2D<klab::DoubleReal, TDaubechiesWaveletFilter<klab::DoubleReal, 4> > fwt;
...
void KFWT2DUnitTest::testDaubechies6Wavelet()
{
    try
    {
        klab::UInt32 m = 8;
        ...
        TFWT2D<klab::DoubleReal, TDaubechiesWaveletFilter<klab::DoubleReal, 6> > fwt;
...
void KFWT2DUnitTest::testDaubechies8Wavelet()
{
    try
    {
        klab::UInt32 m = 8;
        ...
        TFWT2D<klab::DoubleReal, TDaubechiesWaveletFilter<klab::DoubleReal, 8> > fwt;
...
void KFWT2DUnitTest::testDaubechies10Wavelet()
{
    try
    {
        klab::UInt32 m = 8;
        ...
        TFWT2D<klab::DoubleReal, TDaubechiesWaveletFilter<klab::DoubleReal, 10> > fwt;
...
void KFWT2DUnitTest::testDaubechies9_7Wavelet()
{
    try
    {
        klab::UInt32 m = 8;
        ...
        TFWT2D<klab::DoubleReal, TBiorthogonalDaubechiesWaveletFilter<klab::DoubleReal, 9, 7> > fwt;
...
void KFWT2DUnitTest::testDelegateWavelet()
{
    try
    {
        klab::UInt32 m = 8;
        ...
        TFWT2D<klab::DoubleReal, TDelegateWaveletFilter<klab::DoubleReal> > fwt(new THaarWaveletFilter<klab::DoubleReal>());
        TEST_ASSERT(fwt.filter().waveLength() == 2)
...
void KFWT2DUnitTest::testNameWavelet()
{
    try
    {
        klab::UInt32 m = 8;
        ...
        TFWT2D<klab::DoubleReal, TNameWaveletFilter<klab::DoubleReal> > fwt("Haar");
        TEST_ASSERT(fwt.filter().waveLength() == 2)
...
void KFWT2DUnitTest::testCustomWavelet()
{
    try
    {
        klab::UInt32 m = 8;
        ...
        TFWT2D<klab::DoubleReal, TCustomWaveletFilter<klab::DoubleReal> > fwt(TCustomWaveletFilter<klab::DoubleReal>(haarScalingCoefficients, haarWaveletCoefficients));
        TEST_ASSERT(fwt.filter().waveLength() == 2)
