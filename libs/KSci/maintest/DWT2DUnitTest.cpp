...
KDWT2DUnitTest::KDWT2DUnitTest() : Test::Suite()
{
    TEST_ADD(KDWT2DUnitTest::testDefaultConstructor)  
    TEST_ADD(KDWT2DUnitTest::testFilterConstructor)
    TEST_ADD(KDWT2DUnitTest::testCopyConstructor)
    TEST_ADD(KDWT2DUnitTest::testAffectationOperator)

    TEST_ADD(KDWT2DUnitTest::testFilter)
    TEST_ADD(KDWT2DUnitTest::testTransform)
    TEST_ADD(KDWT2DUnitTest::testTransform_02)
    TEST_ADD(KDWT2DUnitTest::testTransform_03)
    TEST_ADD(KDWT2DUnitTest::testInvert)   
    TEST_ADD(KDWT2DUnitTest::testInvert_02)   
    TEST_ADD(KDWT2DUnitTest::testInvert_03)   

    TEST_ADD(KDWT2DUnitTest::testHaarWavelet)
    TEST_ADD(KDWT2DUnitTest::testDaubechies2Wavelet) 
    TEST_ADD(KDWT2DUnitTest::testDaubechies4Wavelet) 
    TEST_ADD(KDWT2DUnitTest::testDaubechies6Wavelet)
    TEST_ADD(KDWT2DUnitTest::testDaubechies8Wavelet)
    TEST_ADD(KDWT2DUnitTest::testDaubechies10Wavelet)
    TEST_ADD(KDWT2DUnitTest::testDaubechies9_7Wavelet)
    TEST_ADD(KDWT2DUnitTest::testDelegateWavelet)
    TEST_ADD(KDWT2DUnitTest::testNameWavelet)
    TEST_ADD(KDWT2DUnitTest::testCustomWavelet)
}

// ---------------------------------------------------------------------------------------------------- //

KDWT2DUnitTest::~KDWT2DUnitTest()
{}

// ---------------------------------------------------------------------------------------------------- //

void KDWT2DUnitTest::testDefaultConstructor()
{
    try
    {
        TDWT2D<klab::DoubleReal> dwt;
        TEST_ASSERT(dwt.filter().waveLength() == 0)
    }
    catch(...)
    {
        TEST_ASSERT(false)
...
void KDWT2DUnitTest::testFilterConstructor()
{
    try
    {
        THaarWaveletFilter<klab::DoubleReal> filter;

        TDWT2D<klab::DoubleReal, THaarWaveletFilter<klab::DoubleReal> > dwt(filter);
        TEST_ASSERT(dwt.filter().waveLength() == 2)
    }
    catch(...)
    {
        TEST_ASSERT(false)
...
void KDWT2DUnitTest::testCopyConstructor()
{
    try
    {
        TDWT2D<klab::DoubleReal> dwt;
        ...
        TDWT2D<klab::DoubleReal> dwt2(dwt);
        TEST_ASSERT(dwt2.filter().waveLength() == 0)
    }
    catch(...)
    {
        TEST_ASSERT(false)
...
void KDWT2DUnitTest::testAffectationOperator()
{
    try
    {
        TDWT2D<klab::DoubleReal> dwt;
...
void KDWT2DUnitTest::testFilter()
{
    try
    {
        TDWT2D<klab::DoubleReal> dwt;
...
void KDWT2DUnitTest::testTransform()
{
    try
    {
        klab::UInt32 m = 8;
        ...
        TDWT2D<klab::DoubleReal, THaarWaveletFilter<klab::DoubleReal> > dwt;
        ...
        dwt.transform(f, F, 2);
        TEST_ASSERT(F.n_rows==m && F.n_cols==n)
        TEST_ASSERT(klab::Equals(F(0, 0), 499.00000000000023, precision))
        TEST_ASSERT(klab::Equals(F(0, 1), 546.00000000000011, precision))
        TEST_ASSERT(klab::Equals(F(0, 2), -10.999999999999968, precision))
        TEST_ASSERT(klab::Equals(F(0, 3), 67.000000000000043, precision))
        TEST_ASSERT(klab::Equals(F(0, 4), 28.999999999999993, precision))
        TEST_ASSERT(klab::Equals(F(0, 5), -28.5, precision))
        TEST_ASSERT(klab::Equals(F(0, 6), 15.000000000000002, precision))
        TEST_ASSERT(klab::Equals(F(0, 7), 51.500000000000014, precision))
        TEST_ASSERT(klab::Equals(F(1, 0), 387.50000000000011, precision))
        TEST_ASSERT(klab::Equals(F(1, 1), 555.5, precision))
        TEST_ASSERT(klab::Equals(F(1, 2), 32.0, precision))
        TEST_ASSERT(klab::Equals(F(1, 3), -10.499999999999986, precision))
        TEST_ASSERT(klab::Equals(F(1, 4), 11.0, precision))
        TEST_ASSERT(klab::Equals(F(1, 5), 6.4999999999999938, precision))
        ...
        // Limit cases.
        dwt.transform(arma::Mat<klab::DoubleReal>(), F);
        TEST_ASSERT(F.n_rows==0 && F.n_cols==0)

        try                                 {dwt.transform(arma::Mat<klab::DoubleReal>(7, 8), F); TEST_ASSERT(false)}
        catch(KSizePowerOf2DWTException&)   {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}

        try                                 {dwt.transform(arma::Mat<klab::DoubleReal>(8, 7), F); TEST_ASSERT(false)}
        catch(KSizePowerOf2DWTException&)   {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}

        try                                 {dwt.transform(arma::Mat<klab::DoubleReal>(7, 7), F); TEST_ASSERT(false)}
        catch(KSizePowerOf2DWTException&)   {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}

        dwt.transform(f, F, 0);
        TEST_ASSERT(F.n_rows==m && F.n_cols==n)
        TEST_ASSERT(klab::Equals(F(0, 0), f(0, 0), precision))
        TEST_ASSERT(klab::Equals(F(0, 1), f(0, 1), precision))
        TEST_ASSERT(klab::Equals(F(0, 2), f(0, 2), precision))
        TEST_ASSERT(klab::Equals(F(0, 3), f(0, 3), precision))
        TEST_ASSERT(klab::Equals(F(0, 4), f(0, 4), precision))
        TEST_ASSERT(klab::Equals(F(0, 5), f(0, 5), precision))
        TEST_ASSERT(klab::Equals(F(0, 6), f(0, 6), precision))
        TEST_ASSERT(klab::Equals(F(0, 7), f(0, 7), precision))
        TEST_ASSERT(klab::Equals(F(1, 0), f(1, 0), precision))
        TEST_ASSERT(klab::Equals(F(1, 1), f(1, 1), precision))
        TEST_ASSERT(klab::Equals(F(1, 2), f(1, 2), precision))
        TEST_ASSERT(klab::Equals(F(1, 3), f(1, 3), precision))
        TEST_ASSERT(klab::Equals(F(1, 4), f(1, 4), precision))
        TEST_ASSERT(klab::Equals(F(1, 5), f(1, 5), precision))
        TEST_ASSERT(klab::Equals(F(1, 6), f(1, 6), precision))
        TEST_ASSERT(klab::Equals(F(1, 7), f(1, 7), precision))
        TEST_ASSERT(klab::Equals(F(2, 0), f(2, 0), precision))
        TEST_ASSERT(klab::Equals(F(2, 1), f(2, 1), precision))
        TEST_ASSERT(klab::Equals(F(2, 2), f(2, 2), precision))
        TEST_ASSERT(klab::Equals(F(2, 3), f(2, 3), precision))
        TEST_ASSERT(klab::Equals(F(2, 4), f(2, 4), precision))
        TEST_ASSERT(klab::Equals(F(2, 5), f(2, 5), precision))
        TEST_ASSERT(klab::Equals(F(2, 6), f(2, 6), precision))
        TEST_ASSERT(klab::Equals(F(2, 7), f(2, 7), precision))
        TEST_ASSERT(klab::Equals(F(3, 0), f(3, 0), precision))
        TEST_ASSERT(klab::Equals(F(3, 1), f(3, 1), precision))
        TEST_ASSERT(klab::Equals(F(3, 2), f(3, 2), precision))
        TEST_ASSERT(klab::Equals(F(3, 3), f(3, 3), precision))
        TEST_ASSERT(klab::Equals(F(3, 4), f(3, 4), precision))
        TEST_ASSERT(klab::Equals(F(3, 5), f(3, 5), precision))
        TEST_ASSERT(klab::Equals(F(3, 6), f(3, 6), precision))
        TEST_ASSERT(klab::Equals(F(3, 7), f(3, 7), precision))
        TEST_ASSERT(klab::Equals(F(4, 0), f(4, 0), precision))
        TEST_ASSERT(klab::Equals(F(4, 1), f(4, 1), precision))
        TEST_ASSERT(klab::Equals(F(4, 2), f(4, 2), precision))
        TEST_ASSERT(klab::Equals(F(4, 3), f(4, 3), precision))
        TEST_ASSERT(klab::Equals(F(4, 4), f(4, 4), precision))
        TEST_ASSERT(klab::Equals(F(4, 5), f(4, 5), precision))
        TEST_ASSERT(klab::Equals(F(4, 6), f(4, 6), precision))
        TEST_ASSERT(klab::Equals(F(4, 7), f(4, 7), precision))
        TEST_ASSERT(klab::Equals(F(5, 0), f(5, 0), precision))
        TEST_ASSERT(klab::Equals(F(5, 1), f(5, 1), precision))
        TEST_ASSERT(klab::Equals(F(5, 2), f(5, 2), precision))
        TEST_ASSERT(klab::Equals(F(5, 3), f(5, 3), precision))
        TEST_ASSERT(klab::Equals(F(5, 4), f(5, 4), precision))
        TEST_ASSERT(klab::Equals(F(5, 5), f(5, 5), precision))
        TEST_ASSERT(klab::Equals(F(5, 6), f(5, 6), precision))
        TEST_ASSERT(klab::Equals(F(5, 7), f(5, 7), precision))
        TEST_ASSERT(klab::Equals(F(6, 0), f(6, 0), precision))
        TEST_ASSERT(klab::Equals(F(6, 1), f(6, 1), precision))
        TEST_ASSERT(klab::Equals(F(6, 2), f(6, 2), precision))
        TEST_ASSERT(klab::Equals(F(6, 3), f(6, 3), precision))
        TEST_ASSERT(klab::Equals(F(6, 4), f(6, 4), precision))
        TEST_ASSERT(klab::Equals(F(6, 5), f(6, 5), precision))
        TEST_ASSERT(klab::Equals(F(6, 6), f(6, 6), precision))
        TEST_ASSERT(klab::Equals(F(6, 7), f(6, 7), precision))
        TEST_ASSERT(klab::Equals(F(7, 0), f(7, 0), precision))
        TEST_ASSERT(klab::Equals(F(7, 1), f(7, 1), precision))
        TEST_ASSERT(klab::Equals(F(7, 2), f(7, 2), precision))
        TEST_ASSERT(klab::Equals(F(7, 3), f(7, 3), precision))
        TEST_ASSERT(klab::Equals(F(7, 4), f(7, 4), precision))
        TEST_ASSERT(klab::Equals(F(7, 5), f(7, 5), precision))
        TEST_ASSERT(klab::Equals(F(7, 6), f(7, 6), precision))
        TEST_ASSERT(klab::Equals(F(7, 7), f(7, 7), precision))

        dwt.transform(f, F, 100);
        TEST_ASSERT(F.n_rows==m && F.n_cols==n)
        TEST_ASSERT(klab::Equals(F(0, 0), 994.00000000000034, precision))
        TEST_ASSERT(klab::Equals(F(0, 1), -107.49999999999991, precision))
        TEST_ASSERT(klab::Equals(F(0, 2), -10.999999999999968, precision))
...
void KDWT2DUnitTest::testTransform_02()
{
    try
    {
        klab::UInt32 m = 8;
        ...
        TEST_ASSERT(F.n_rows==m && F.n_cols==n)
        TEST_ASSERT(klab::Equals(F(0, 0), 499.00000000000023, precision))
        TEST_ASSERT(klab::Equals(F(0, 1), -10.999999999999968, precision))
        TEST_ASSERT(klab::Equals(F(0, 2), 28.999999999999993, precision))
        TEST_ASSERT(klab::Equals(F(0, 3), -28.5, precision))
        TEST_ASSERT(klab::Equals(F(1, 0), 387.50000000000011, precision))
        TEST_ASSERT(klab::Equals(F(1, 1), 32.0, precision))
        TEST_ASSERT(klab::Equals(F(1, 2), 11.0, precision))
        TEST_ASSERT(klab::Equals(F(1, 3), 6.4999999999999938, precision))
        TEST_ASSERT(klab::Equals(F(2, 0), 26.5, precision))
        TEST_ASSERT(klab::Equals(F(2, 1), -18.499999999999989, precision))
        TEST_ASSERT(klab::Equals(F(2, 2), 15.500000000000005, precision))
        TEST_ASSERT(klab::Equals(F(2, 3), -23.000000000000007, precision))
        TEST_ASSERT(klab::Equals(F(3, 0), 19.000000000000028, precision))
        TEST_ASSERT(klab::Equals(F(3, 1), 2.5, precision))
        TEST_ASSERT(klab::Equals(F(3, 2), 47.000000000000014, precision))
        TEST_ASSERT(klab::Equals(F(3, 3), -15.500000000000005, precision))
        TEST_ASSERT(klab::Equals(F(4, 0), 13.000000000000014, precision))
        TEST_ASSERT(klab::Equals(F(4, 1), -9.4999999999999716, precision))
        TEST_ASSERT(klab::Equals(F(4, 2), 10.0, precision))
        TEST_ASSERT(klab::Equals(F(4, 3), 18.5, precision))
        TEST_ASSERT(klab::Equals(F(5, 0), -1.9999999999999858, precision))
        TEST_ASSERT(klab::Equals(F(5, 1), 40.500000000000014, precision))
        TEST_ASSERT(klab::Equals(F(5, 2), -0.99999999999999734, precision))
        TEST_ASSERT(klab::Equals(F(5, 3), -15.500000000000007, precision))
        TEST_ASSERT(klab::Equals(F(6, 0), 7.4999999999999716, precision))
        TEST_ASSERT(klab::Equals(F(6, 1), 5.0, precision))
        TEST_ASSERT(klab::Equals(F(6, 2), -1.4999999999999911, precision))
        TEST_ASSERT(klab::Equals(F(6, 3), -22.0, precision))
        TEST_ASSERT(klab::Equals(F(7, 0), 2.0, precision))
        TEST_ASSERT(klab::Equals(F(7, 1), -8.5, precision))
        TEST_ASSERT(klab::Equals(F(7, 2), -8.0000000000000036, precision))
        TEST_ASSERT(klab::Equals(F(7, 3), 22.5, precision))


        dwt.transform(f, F, 1);
        TEST_ASSERT(F.n_rows==m && F.n_cols==n)
        TEST_ASSERT(klab::Equals(F(0, 0), 248.00000000000006, precision))
        TEST_ASSERT(klab::Equals(F(0, 1), 277.5, precision))
        TEST_ASSERT(klab::Equals(F(0, 2), 28.999999999999993, precision))
        TEST_ASSERT(klab::Equals(F(0, 3), -28.5, precision))
        TEST_ASSERT(klab::Equals(F(1, 0), 240.00000000000006, precision))
        TEST_ASSERT(klab::Equals(F(1, 1), 232.50000000000006, precision))
        TEST_ASSERT(klab::Equals(F(1, 2), 11.0, precision))
        TEST_ASSERT(klab::Equals(F(1, 3), 6.4999999999999938, precision))
        TEST_ASSERT(klab::Equals(F(2, 0), 220.50000000000003, precision))
        TEST_ASSERT(klab::Equals(F(2, 1), 186.00000000000003, precision))
        TEST_ASSERT(klab::Equals(F(2, 2), 15.500000000000005, precision))
        TEST_ASSERT(klab::Equals(F(2, 3), -23.000000000000007, precision))
        TEST_ASSERT(klab::Equals(F(3, 0), 199.00000000000003, precision))
        TEST_ASSERT(klab::Equals(F(3, 1), 169.50000000000003, precision))
        TEST_ASSERT(klab::Equals(F(3, 2), 47.000000000000014, precision))
        TEST_ASSERT(klab::Equals(F(3, 3), -15.500000000000005, precision))
        TEST_ASSERT(klab::Equals(F(4, 0), 13.000000000000014, precision))
        TEST_ASSERT(klab::Equals(F(4, 1), -9.4999999999999716, precision))
        ...
        try                                 {dwt.transform(arma::Mat<klab::DoubleReal>(8, 3), F); TEST_ASSERT(false)}
        catch(KSizePowerOf2DWTException&)   {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}

        try                                 {dwt.transform(arma::Mat<klab::DoubleReal>(7, 4), F); TEST_ASSERT(false)}
        catch(KSizePowerOf2DWTException&)   {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}

        try                                 {dwt.transform(arma::Mat<klab::DoubleReal>(7, 3), F); TEST_ASSERT(false)}
        catch(KSizePowerOf2DWTException&)   {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}
...
void KDWT2DUnitTest::testTransform_03()
{
    try
    {
        klab::UInt32 m = 4;
        ...
        TEST_ASSERT(klab::Equals(F(0, 6), 15.000000000000002, precision))
        TEST_ASSERT(klab::Equals(F(0, 7), 51.500000000000014, precision))
        TEST_ASSERT(klab::Equals(F(1, 0), 26.5, precision))
        TEST_ASSERT(klab::Equals(F(1, 1), -25.5, precision))
        TEST_ASSERT(klab::Equals(F(1, 2), -18.499999999999989, precision))
        TEST_ASSERT(klab::Equals(F(1, 3), 0.49999999999998579, precision))
        TEST_ASSERT(klab::Equals(F(1, 4), 11.0, precision))
        TEST_ASSERT(klab::Equals(F(1, 5), 6.4999999999999938, precision))
        TEST_ASSERT(klab::Equals(F(1, 6), 13.000000000000014, precision))
        TEST_ASSERT(klab::Equals(F(1, 7), -45.500000000000007, precision))
        TEST_ASSERT(klab::Equals(F(2, 0), 13.000000000000014, precision))
        TEST_ASSERT(klab::Equals(F(2, 1), -9.4999999999999716, precision))
        TEST_ASSERT(klab::Equals(F(2, 2), -24.0, precision))
        TEST_ASSERT(klab::Equals(F(2, 3), 23.499999999999986, precision))
        TEST_ASSERT(klab::Equals(F(2, 4), 10.0, precision))
        TEST_ASSERT(klab::Equals(F(2, 5), 18.5, precision))
        TEST_ASSERT(klab::Equals(F(2, 6), -31.000000000000014, precision))
        TEST_ASSERT(klab::Equals(F(2, 7), 18.500000000000004, precision))
        TEST_ASSERT(klab::Equals(F(3, 0), -1.9999999999999858, precision))
        TEST_ASSERT(klab::Equals(F(3, 1), 40.500000000000014, precision))
        TEST_ASSERT(klab::Equals(F(3, 2), 36.0, precision))
        TEST_ASSERT(klab::Equals(F(3, 3), -1.5, precision))
        TEST_ASSERT(klab::Equals(F(3, 4), -0.99999999999999734, precision))
        TEST_ASSERT(klab::Equals(F(3, 5), -15.500000000000007, precision))
        TEST_ASSERT(klab::Equals(F(3, 6), -26.0, precision))
        TEST_ASSERT(klab::Equals(F(3, 7), 14.499999999999998, precision))
        ...
        TEST_ASSERT(klab::Equals(F(0, 0), 248.00000000000006, precision))
        TEST_ASSERT(klab::Equals(F(0, 1), 277.5, precision))
        TEST_ASSERT(klab::Equals(F(0, 2), 294.00000000000006, precision))
        TEST_ASSERT(klab::Equals(F(0, 3), 226.50000000000006, precision))
        TEST_ASSERT(klab::Equals(F(0, 4), 28.999999999999993, precision))
        TEST_ASSERT(klab::Equals(F(0, 5), -28.5, precision))
        TEST_ASSERT(klab::Equals(F(0, 6), 15.000000000000002, precision))
        TEST_ASSERT(klab::Equals(F(0, 7), 51.500000000000014, precision))
        TEST_ASSERT(klab::Equals(F(1, 0), 240.00000000000006, precision))
        TEST_ASSERT(klab::Equals(F(1, 1), 232.50000000000006, precision))
        TEST_ASSERT(klab::Equals(F(1, 2), 319.00000000000006, precision))
        TEST_ASSERT(klab::Equals(F(1, 3), 252.50000000000003, precision))
        TEST_ASSERT(klab::Equals(F(1, 4), 11.0, precision))
        TEST_ASSERT(klab::Equals(F(1, 5), 6.4999999999999938, precision))
        TEST_ASSERT(klab::Equals(F(1, 6), 13.000000000000014, precision))
        TEST_ASSERT(klab::Equals(F(1, 7), -45.500000000000007, precision))
        ...
        try                                 {dwt.transform(arma::Mat<klab::DoubleReal>(3, 8), F); TEST_ASSERT(false)}
        catch(KSizePowerOf2DWTException&)   {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}

        try                                 {dwt.transform(arma::Mat<klab::DoubleReal>(4, 7), F); TEST_ASSERT(false)}
        catch(KSizePowerOf2DWTException&)   {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}

        try                                 {dwt.transform(arma::Mat<klab::DoubleReal>(3, 7), F); TEST_ASSERT(false)}
        catch(KSizePowerOf2DWTException&)   {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}
...
void KDWT2DUnitTest::testInvert()
{
    try
    {
        klab::UInt32 m = 8;
        ...
        // Limit cases.
        dwt.invert(arma::Mat<klab::DoubleReal>(), fR);
        TEST_ASSERT(fR.n_rows==0 && fR.n_cols==0)

        try                                 {dwt.invert(arma::Mat<klab::DoubleReal>(7, 8), fR); TEST_ASSERT(false)}
        catch(KSizePowerOf2DWTException&)   {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}

        try                                 {dwt.invert(arma::Mat<klab::DoubleReal>(8, 7), fR); TEST_ASSERT(false)}
        catch(KSizePowerOf2DWTException&)   {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}

        try                                 {dwt.invert(arma::Mat<klab::DoubleReal>(7, 7), fR); TEST_ASSERT(false)}
        catch(KSizePowerOf2DWTException&)   {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}
        ...
        dwt.invert(F, fR, 0);
        TEST_ASSERT(fR.n_rows==m && fR.n_cols==n)
        TEST_ASSERT(klab::Equals(fR(0, 0), 994.00000000000034, precision))
        TEST_ASSERT(klab::Equals(fR(0, 1), -107.49999999999991, precision))
        TEST_ASSERT(klab::Equals(fR(0, 2), -10.999999999999968, precision))
        TEST_ASSERT(klab::Equals(fR(0, 3), 67.000000000000043, precision))
        TEST_ASSERT(klab::Equals(fR(0, 4), 28.999999999999993, precision))
        TEST_ASSERT(klab::Equals(fR(0, 5), -28.5, precision))
        TEST_ASSERT(klab::Equals(fR(0, 6), 15.000000000000002, precision))
        TEST_ASSERT(klab::Equals(fR(0, 7), 51.500000000000014, precision))
        TEST_ASSERT(klab::Equals(fR(1, 0), 51.000000000000114, precision))
        TEST_ASSERT(klab::Equals(fR(1, 1), 60.500000000000007, precision))
        TEST_ASSERT(klab::Equals(fR(1, 2), 32.0, precision))
        TEST_ASSERT(klab::Equals(fR(1, 3), -10.499999999999986, precision))
        TEST_ASSERT(klab::Equals(fR(1, 4), 11.0, precision))
        TEST_ASSERT(klab::Equals(fR(1, 5), 6.4999999999999938, precision))
        TEST_ASSERT(klab::Equals(fR(1, 6), 13.000000000000014, precision))
        TEST_ASSERT(klab::Equals(fR(1, 7), -45.500000000000007, precision))
        TEST_ASSERT(klab::Equals(fR(2, 0), 26.5, precision))
        TEST_ASSERT(klab::Equals(fR(2, 1), -25.5, precision))
        TEST_ASSERT(klab::Equals(fR(2, 2), -18.499999999999989, precision))
        TEST_ASSERT(klab::Equals(fR(2, 3), 0.49999999999998579, precision))
        TEST_ASSERT(klab::Equals(fR(2, 4), 15.500000000000005, precision))
        TEST_ASSERT(klab::Equals(fR(2, 5), -23.000000000000007, precision))
        TEST_ASSERT(klab::Equals(fR(2, 6), 54.500000000000007, precision))
        TEST_ASSERT(klab::Equals(fR(2, 7), -47.5, precision))
        TEST_ASSERT(klab::Equals(fR(3, 0), 19.000000000000028, precision))
        TEST_ASSERT(klab::Equals(fR(3, 1), 0.50000000000005684, precision))
        TEST_ASSERT(klab::Equals(fR(3, 2), 2.5, precision))
        TEST_ASSERT(klab::Equals(fR(3, 3), -68.500000000000014, precision))
        TEST_ASSERT(klab::Equals(fR(3, 4), 47.000000000000014, precision))
        TEST_ASSERT(klab::Equals(fR(3, 5), -15.500000000000005, precision))
        TEST_ASSERT(klab::Equals(fR(3, 6), -6.499999999999992, precision))
        TEST_ASSERT(klab::Equals(fR(3, 7), 20.500000000000007, precision))
        TEST_ASSERT(klab::Equals(fR(4, 0), 13.000000000000014, precision))
        TEST_ASSERT(klab::Equals(fR(4, 1), -9.4999999999999716, precision))
        TEST_ASSERT(klab::Equals(fR(4, 2), -24.0, precision))
        TEST_ASSERT(klab::Equals(fR(4, 3), 23.499999999999986, precision))
        TEST_ASSERT(klab::Equals(fR(4, 4), 10.0, precision))
        TEST_ASSERT(klab::Equals(fR(4, 5), 18.5, precision))
        TEST_ASSERT(klab::Equals(fR(4, 6), -31.000000000000014, precision))
        TEST_ASSERT(klab::Equals(fR(4, 7), 18.500000000000004, precision))
        TEST_ASSERT(klab::Equals(fR(5, 0), -1.9999999999999858, precision))
        TEST_ASSERT(klab::Equals(fR(5, 1), 40.500000000000014, precision))
        TEST_ASSERT(klab::Equals(fR(5, 2), 36.0, precision))
        TEST_ASSERT(klab::Equals(fR(5, 3), -1.5, precision))
        TEST_ASSERT(klab::Equals(fR(5, 4), -0.99999999999999734, precision))
        TEST_ASSERT(klab::Equals(fR(5, 5), -15.500000000000007, precision))
        TEST_ASSERT(klab::Equals(fR(5, 6), -26.0, precision))
        TEST_ASSERT(klab::Equals(fR(5, 7), 14.499999999999998, precision))
        TEST_ASSERT(klab::Equals(fR(6, 0), 7.4999999999999716, precision))
        TEST_ASSERT(klab::Equals(fR(6, 1), 5.0, precision))
        TEST_ASSERT(klab::Equals(fR(6, 2), 11.5, precision))
        TEST_ASSERT(klab::Equals(fR(6, 3), -21.499999999999972, precision))
        TEST_ASSERT(klab::Equals(fR(6, 4), -1.4999999999999911, precision))
        TEST_ASSERT(klab::Equals(fR(6, 5), -22.0, precision))
        TEST_ASSERT(klab::Equals(fR(6, 6), 1.5000000000000071, precision))
        TEST_ASSERT(klab::Equals(fR(6, 7), 3.4999999999999964, precision))
        TEST_ASSERT(klab::Equals(fR(7, 0), 2.0, precision))
        TEST_ASSERT(klab::Equals(fR(7, 1), -8.5, precision))
        TEST_ASSERT(klab::Equals(fR(7, 2), -17.500000000000028, precision))
        TEST_ASSERT(klab::Equals(fR(7, 3), 30.5, precision))
        TEST_ASSERT(klab::Equals(fR(7, 4), -8.0000000000000036, precision))
        TEST_ASSERT(klab::Equals(fR(7, 5), 22.5, precision))
        TEST_ASSERT(klab::Equals(fR(7, 6), 19.499999999999996, precision))
        TEST_ASSERT(klab::Equals(fR(7, 7), -11.499999999999993, precision))       
...
void KDWT2DUnitTest::testInvert_02()
{
    try
    {
        klab::UInt32 m = 8;
        ...
        try                                 {dwt.invert(arma::Mat<klab::DoubleReal>(7, 4), fR); TEST_ASSERT(false)}
        catch(KSizePowerOf2DWTException&)   {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}

        try                                 {dwt.invert(arma::Mat<klab::DoubleReal>(8, 3), fR); TEST_ASSERT(false)}
        catch(KSizePowerOf2DWTException&)   {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}

        try                                 {dwt.invert(arma::Mat<klab::DoubleReal>(7, 3), fR); TEST_ASSERT(false)}
        catch(KSizePowerOf2DWTException&)   {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}
        ...
        dwt.invert(F, fR, 0);
        TEST_ASSERT(fR.n_rows==m && fR.n_cols==n)
        TEST_ASSERT(klab::Equals(fR(0, 0), 499.00000000000023, precision))
        TEST_ASSERT(klab::Equals(fR(0, 1), -10.999999999999968, precision))
        TEST_ASSERT(klab::Equals(fR(0, 2), 28.999999999999993, precision))
        TEST_ASSERT(klab::Equals(fR(0, 3), -28.5, precision))
        TEST_ASSERT(klab::Equals(fR(1, 0), 387.50000000000011, precision))
        TEST_ASSERT(klab::Equals(fR(1, 1), 32.0, precision))
        TEST_ASSERT(klab::Equals(fR(1, 2), 11.0, precision))
        TEST_ASSERT(klab::Equals(fR(1, 3), 6.4999999999999938, precision))
        TEST_ASSERT(klab::Equals(fR(2, 0), 26.5, precision))
        TEST_ASSERT(klab::Equals(fR(2, 1), -18.499999999999989, precision))
        TEST_ASSERT(klab::Equals(fR(2, 2), 15.500000000000005, precision))
        TEST_ASSERT(klab::Equals(fR(2, 3), -23.000000000000007, precision))
        TEST_ASSERT(klab::Equals(fR(3, 0), 19.000000000000028, precision))
        TEST_ASSERT(klab::Equals(fR(3, 1), 2.5, precision))
        TEST_ASSERT(klab::Equals(fR(3, 2), 47.000000000000014, precision))
        TEST_ASSERT(klab::Equals(fR(3, 3), -15.500000000000005, precision))
        TEST_ASSERT(klab::Equals(fR(4, 0), 13.000000000000014, precision))
        TEST_ASSERT(klab::Equals(fR(4, 1), -9.4999999999999716, precision))
        TEST_ASSERT(klab::Equals(fR(4, 2), 10.0, precision))
        TEST_ASSERT(klab::Equals(fR(4, 3), 18.5, precision))
        TEST_ASSERT(klab::Equals(fR(5, 0), -1.9999999999999858, precision))
        TEST_ASSERT(klab::Equals(fR(5, 1), 40.500000000000014, precision))
        TEST_ASSERT(klab::Equals(fR(5, 2), -0.99999999999999734, precision))
        TEST_ASSERT(klab::Equals(fR(5, 3), -15.500000000000007, precision))
        TEST_ASSERT(klab::Equals(fR(6, 0), 7.4999999999999716, precision))
        TEST_ASSERT(klab::Equals(fR(6, 1), 5.0, precision))
        TEST_ASSERT(klab::Equals(fR(6, 2), -1.4999999999999911, precision))
        TEST_ASSERT(klab::Equals(fR(6, 3), -22.0, precision))
        TEST_ASSERT(klab::Equals(fR(7, 0), 2.0, precision))
        TEST_ASSERT(klab::Equals(fR(7, 1), -8.5, precision))
        TEST_ASSERT(klab::Equals(fR(7, 2), -8.0000000000000036, precision))
        TEST_ASSERT(klab::Equals(fR(7, 3), 22.5, precision))       
...
void KDWT2DUnitTest::testInvert_03()
{
    try
    {
        klab::UInt32 m = 4;
        ...
        try                                 {dwt.invert(arma::Mat<klab::DoubleReal>(3, 8), fR); TEST_ASSERT(false)}
        catch(KSizePowerOf2DWTException&)   {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}

        try                                 {dwt.invert(arma::Mat<klab::DoubleReal>(4, 7), fR); TEST_ASSERT(false)}
        catch(KSizePowerOf2DWTException&)   {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}

        try                                 {dwt.invert(arma::Mat<klab::DoubleReal>(3, 7), fR); TEST_ASSERT(false)}
        catch(KSizePowerOf2DWTException&)   {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}
        ...
        TEST_ASSERT(fR.n_rows==m && fR.n_cols==n)
        TEST_ASSERT(klab::Equals(fR(0, 0), 499.00000000000023, precision))
        TEST_ASSERT(klab::Equals(fR(0, 1), 546.00000000000011, precision))
        TEST_ASSERT(klab::Equals(fR(0, 2), -10.999999999999968, precision))
        TEST_ASSERT(klab::Equals(fR(0, 3), 67.000000000000043, precision))
        TEST_ASSERT(klab::Equals(fR(0, 4), 28.999999999999993, precision))
        TEST_ASSERT(klab::Equals(fR(0, 5), -28.5, precision))
        TEST_ASSERT(klab::Equals(fR(0, 6), 15.000000000000002, precision))
        TEST_ASSERT(klab::Equals(fR(0, 7), 51.500000000000014, precision))
        TEST_ASSERT(klab::Equals(fR(1, 0), 26.5, precision))
        TEST_ASSERT(klab::Equals(fR(1, 1), -25.5, precision))
        TEST_ASSERT(klab::Equals(fR(1, 2), -18.499999999999989, precision))
        TEST_ASSERT(klab::Equals(fR(1, 3), 0.49999999999998579, precision))
        TEST_ASSERT(klab::Equals(fR(1, 4), 11.0, precision))
        TEST_ASSERT(klab::Equals(fR(1, 5), 6.4999999999999938, precision))
        TEST_ASSERT(klab::Equals(fR(1, 6), 13.000000000000014, precision))
        TEST_ASSERT(klab::Equals(fR(1, 7), -45.500000000000007, precision))
        TEST_ASSERT(klab::Equals(fR(2, 0), 13.000000000000014, precision))
        TEST_ASSERT(klab::Equals(fR(2, 1), -9.4999999999999716, precision))
        TEST_ASSERT(klab::Equals(fR(2, 2), -24.0, precision))
        TEST_ASSERT(klab::Equals(fR(2, 3), 23.499999999999986, precision))
        TEST_ASSERT(klab::Equals(fR(2, 4), 10.0, precision))
        TEST_ASSERT(klab::Equals(fR(2, 5), 18.5, precision))
        TEST_ASSERT(klab::Equals(fR(2, 6), -31.000000000000014, precision))
        TEST_ASSERT(klab::Equals(fR(2, 7), 18.500000000000004, precision))
        TEST_ASSERT(klab::Equals(fR(3, 0), -1.9999999999999858, precision))
        TEST_ASSERT(klab::Equals(fR(3, 1), 40.500000000000014, precision))
        TEST_ASSERT(klab::Equals(fR(3, 2), 36.0, precision))
        TEST_ASSERT(klab::Equals(fR(3, 3), -1.5, precision))
        TEST_ASSERT(klab::Equals(fR(3, 4), -0.99999999999999734, precision))
        TEST_ASSERT(klab::Equals(fR(3, 5), -15.500000000000007, precision))
        TEST_ASSERT(klab::Equals(fR(3, 6), -26.0, precision))
        TEST_ASSERT(klab::Equals(fR(3, 7), 14.499999999999998, precision))      
...
void KDWT2DUnitTest::testHaarWavelet()
{
    try
    {
        klab::UInt32 m = 8;
...
void KDWT2DUnitTest::testDaubechies2Wavelet()
{
    try
    {
        klab::UInt32 m = 8;
        ...
        TDWT2D<klab::DoubleReal, TDaubechiesWaveletFilter<klab::DoubleReal, 2> > dwt;
...
void KDWT2DUnitTest::testDaubechies4Wavelet()
{
    try
    {
        klab::UInt32 m = 8;
        ...
        TDWT2D<klab::DoubleReal, TDaubechiesWaveletFilter<klab::DoubleReal, 4> > dwt;
...
void KDWT2DUnitTest::testDaubechies6Wavelet()
{
    try
    {
        klab::UInt32 m = 8;
        ...
        TDWT2D<klab::DoubleReal, TDaubechiesWaveletFilter<klab::DoubleReal, 6> > dwt;
...
void KDWT2DUnitTest::testDaubechies8Wavelet()
{
    try
    {
        klab::UInt32 m = 8;
        ...
        TDWT2D<klab::DoubleReal, TDaubechiesWaveletFilter<klab::DoubleReal, 8> > dwt;
...
void KDWT2DUnitTest::testDaubechies10Wavelet()
{
    try
    {
        klab::UInt32 m = 8;
        ...
        TDWT2D<klab::DoubleReal, TDaubechiesWaveletFilter<klab::DoubleReal, 10> > dwt;
...
void KDWT2DUnitTest::testDaubechies9_7Wavelet()
{
    try
    {
        klab::UInt32 m = 8;
        klab::UInt32 n = 8;
        klab::DoubleReal precision = 1e-8;
        ...
        TDWT2D<klab::DoubleReal, TBiorthogonalDaubechiesWaveletFilter<klab::DoubleReal, 9, 7> > dwt;
...
void KDWT2DUnitTest::testDelegateWavelet()
{
    try
    {
        klab::UInt32 m = 8;
        ...
        TDWT2D<klab::DoubleReal, TDelegateWaveletFilter<klab::DoubleReal> > dwt(new THaarWaveletFilter<klab::DoubleReal>());
        TEST_ASSERT(dwt.filter().waveLength() == 2)
        ...
        dwt.filter().setFilter(new TDaubechiesWaveletFilter<klab::DoubleReal, 4>());
        TEST_ASSERT(dwt.filter().waveLength() == 4)
        ...
        dwt.filter().setFilter(daubechies8);
        TEST_ASSERT(dwt.filter().waveLength() == 8)
...
void KDWT2DUnitTest::testNameWavelet()
{
    try
    {
        klab::UInt32 m = 8;
        ...
        TDWT2D<klab::DoubleReal, TNameWaveletFilter<klab::DoubleReal> > dwt("Haar");
        TEST_ASSERT(dwt.filter().waveLength() == 2)
        ...
        dwt.filter().set("Daubechies6");
        TEST_ASSERT(dwt.filter().waveLength() == 6)
        ...
        precision = 1e-11;
        dwt.filter().set("Daubechies10");
        TEST_ASSERT(dwt.filter().waveLength() == 10)
        ...
        precision = 1e-8;
        dwt.filter().set("Daubechies9.7");
        TEST_ASSERT(dwt.filter().waveLength() == 9)
        ...
        // Limit cases.
        try                                         {dwt.filter().set("FezG4ged"); TEST_ASSERT(false)}
        catch(KUnknownNameWaveletFilterException&)  {TEST_ASSERT(true)}
        catch(...)                                  {TEST_ASSERT(false)}

        try                                         {TDWT1D<klab::DoubleReal, TNameWaveletFilter<klab::DoubleReal> > dwt0("FezG4ged"); TEST_ASSERT(false)}
        catch(KUnknownNameWaveletFilterException&)  {TEST_ASSERT(true)}
        catch(...)                                  {TEST_ASSERT(false)}
    }
    catch(...)
...
void KDWT2DUnitTest::testCustomWavelet()
{
    try
    {
        klab::UInt32 m = 8;
        ...
        TDWT2D<klab::DoubleReal, TCustomWaveletFilter<klab::DoubleReal> > dwt(TCustomWaveletFilter<klab::DoubleReal>(haarScalingCoefficients, haarWaveletCoefficients));
        TEST_ASSERT(dwt.filter().waveLength() == 2)
        ...
        dwt.filter().set(db4ScalingCoefficients, db4WaveletCoefficients);
        TEST_ASSERT(dwt.filter().waveLength() == 4)
        ...
        // Limit cases.
        try                                             {dwt.filter().setH0Coefficient(dwt.filter().waveLength(), 1.2345); TEST_ASSERT(false)}
        catch(KOutOfBoundCustomWaveletFilterException&) {TEST_ASSERT(true)}
        catch(...)                                      {TEST_ASSERT(false)}

        try                                             {dwt.filter().setH1Coefficient(dwt.filter().waveLength(), 1.2345); TEST_ASSERT(false)}
        catch(KOutOfBoundCustomWaveletFilterException&) {TEST_ASSERT(true)}
        catch(...)                                      {TEST_ASSERT(false)}
    }
    catch(...)
