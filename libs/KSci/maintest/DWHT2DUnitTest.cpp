...
KDWHT2DUnitTest::KDWHT2DUnitTest() : Test::Suite()
{
    TEST_ADD(KDWHT2DUnitTest::testDefaultConstructor)  
    TEST_ADD(KDWHT2DUnitTest::testCopyConstructor)
    TEST_ADD(KDWHT2DUnitTest::testAffectationOperator)

    TEST_ADD(KDWHT2DUnitTest::testTransform)
    TEST_ADD(KDWHT2DUnitTest::testTransform_02)
    TEST_ADD(KDWHT2DUnitTest::testTransform_03)
    TEST_ADD(KDWHT2DUnitTest::testInvert) 
    TEST_ADD(KDWHT2DUnitTest::testInvert_02)  
    TEST_ADD(KDWHT2DUnitTest::testInvert_03)  
}

// ---------------------------------------------------------------------------------------------------- //

KDWHT2DUnitTest::~KDWHT2DUnitTest()
{}

// ---------------------------------------------------------------------------------------------------- //

void KDWHT2DUnitTest::testDefaultConstructor()
{
    try
    {
        TDWHT2D<klab::DoubleReal> dwht;
        TEST_ASSERT(true)

        TDWHT2D<std::complex<klab::DoubleReal> > cdwht;
        TEST_ASSERT(true)
    }
    catch(...)
    {
...
void KDWHT2DUnitTest::testCopyConstructor()
{
    try
    {
        TDWHT2D<klab::DoubleReal> dwht;
        TDWHT2D<klab::DoubleReal> dwhtCopy(dwht);
        TEST_ASSERT(true)

        TDWHT2D<std::complex<klab::DoubleReal> > cdwht;
        TDWHT2D<std::complex<klab::DoubleReal> > cdwhtCopy(cdwht);
        TEST_ASSERT(true)
    }
    catch(...)
    {
...
void KDWHT2DUnitTest::testAffectationOperator()
{
    try
    {
        TDWHT2D<klab::DoubleReal> dwht;
        TDWHT2D<klab::DoubleReal> dwhtCopy; 
        dwhtCopy = dwht;
        TEST_ASSERT(true)

        TDWHT2D<std::complex<klab::DoubleReal> > cdwht;
        TDWHT2D<std::complex<klab::DoubleReal> > cdwhtCopy;
        cdwhtCopy = cdwht;
        TEST_ASSERT(true)
    }
    catch(...)
...
void KDWHT2DUnitTest::testTransform()
{
    try
    {
        klab::UInt32 m = 8;
        ...
        // Limit cases.
        dwht.transform(arma::Mat<klab::DoubleReal>(), F);
        TEST_ASSERT(F.n_rows==0 && F.n_cols==0)

        try                                 {dwht.transform(arma::Mat<klab::DoubleReal>(7, 8), F); TEST_ASSERT(false)}
        catch(KSizePowerOf2DWHTException&)  {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}

        try                                 {dwht.transform(arma::Mat<klab::DoubleReal>(8, 7), F); TEST_ASSERT(false)}
        catch(KSizePowerOf2DWHTException&)  {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}

        try                                 {dwht.transform(arma::Mat<klab::DoubleReal>(7, 7), F); TEST_ASSERT(false)}
        catch(KSizePowerOf2DWHTException&)  {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}
    }
    catch(...)
...
void KDWHT2DUnitTest::testTransform_02()
{
    try
    {
        klab::UInt32 m = 8;
        ...
        try                                 {dwht.transform(arma::Mat<klab::DoubleReal>(8, 3), F); TEST_ASSERT(false)}
        catch(KSizePowerOf2DWHTException&)  {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}

        try                                 {dwht.transform(arma::Mat<klab::DoubleReal>(7, 4), F); TEST_ASSERT(false)}
        catch(KSizePowerOf2DWHTException&)  {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}

        try                                 {dwht.transform(arma::Mat<klab::DoubleReal>(7, 3), F); TEST_ASSERT(false)}
        catch(KSizePowerOf2DWHTException&)  {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}
    }
    catch(...)
...
void KDWHT2DUnitTest::testTransform_03()
{
    try
    {
        klab::UInt32 m = 4;
        ...
        try                                 {dwht.transform(arma::Mat<klab::DoubleReal>(3, 8), F); TEST_ASSERT(false)}
        catch(KSizePowerOf2DWHTException&)  {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}

        try                                 {dwht.transform(arma::Mat<klab::DoubleReal>(4, 9), F); TEST_ASSERT(false)}
        catch(KSizePowerOf2DWHTException&)  {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}

        try                                 {dwht.transform(arma::Mat<klab::DoubleReal>(3, 7), F); TEST_ASSERT(false)}
        catch(KSizePowerOf2DWHTException&)  {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}
    }
    catch(...)
...
void KDWHT2DUnitTest::testInvert()
{
    try
    {
        klab::UInt32 m = 8;
        ...
        try                                 {dwht.invert(arma::Mat<klab::DoubleReal>(7, 8), fr); TEST_ASSERT(false)}
        catch(KSizePowerOf2DWHTException&)  {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}

        try                                 {dwht.invert(arma::Mat<klab::DoubleReal>(8, 7), fr); TEST_ASSERT(false)}
        catch(KSizePowerOf2DWHTException&)  {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}

        try                                 {dwht.invert(arma::Mat<klab::DoubleReal>(7, 7), fr); TEST_ASSERT(false)}
        catch(KSizePowerOf2DWHTException&)  {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}
    }
    catch(...)
...
void KDWHT2DUnitTest::testInvert_02()
{
    try
    {
        klab::UInt32 m = 8;
        ...
        try                                 {dwht.invert(arma::Mat<klab::DoubleReal>(7, 4), fr); TEST_ASSERT(false)}
        catch(KSizePowerOf2DWHTException&)  {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}

        try                                 {dwht.invert(arma::Mat<klab::DoubleReal>(8, 3), fr); TEST_ASSERT(false)}
        catch(KSizePowerOf2DWHTException&)  {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}

        try                                 {dwht.invert(arma::Mat<klab::DoubleReal>(7, 3), fr); TEST_ASSERT(false)}
        catch(KSizePowerOf2DWHTException&)  {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}
    }
    catch(...)
...
void KDWHT2DUnitTest::testInvert_03()
{
    try
    {
        klab::UInt32 m = 4;
        ...
        try                                 {dwht.invert(arma::Mat<klab::DoubleReal>(4, 7), fr); TEST_ASSERT(false)}
        catch(KSizePowerOf2DWHTException&)  {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}

        try                                 {dwht.invert(arma::Mat<klab::DoubleReal>(3, 8), fr); TEST_ASSERT(false)}
        catch(KSizePowerOf2DWHTException&)  {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}

        try                                 {dwht.invert(arma::Mat<klab::DoubleReal>(3, 7), fr); TEST_ASSERT(false)}
        catch(KSizePowerOf2DWHTException&)  {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}
    }
    catch(...)
