...
KDFT1DUnitTest::KDFT1DUnitTest() : Test::Suite()
{
    TEST_ADD(KDFT1DUnitTest::testDefaultConstructor)  
    TEST_ADD(KDFT1DUnitTest::testShiftConstructor)
    TEST_ADD(KDFT1DUnitTest::testCopyConstructor)
    TEST_ADD(KDFT1DUnitTest::testAffectationOperator)

    TEST_ADD(KDFT1DUnitTest::testSetShift)
    TEST_ADD(KDFT1DUnitTest::testShift)
    TEST_ADD(KDFT1DUnitTest::testTransform)
    TEST_ADD(KDFT1DUnitTest::testTransform_Real)
    TEST_ADD(KDFT1DUnitTest::testTransform_02)  
    TEST_ADD(KDFT1DUnitTest::testTransform_02_Real) 
    TEST_ADD(KDFT1DUnitTest::testInvert)   
    TEST_ADD(KDFT1DUnitTest::testInvert_Real)     
    TEST_ADD(KDFT1DUnitTest::testInvert_02)  
    TEST_ADD(KDFT1DUnitTest::testInvert_02_Real)
}

// ---------------------------------------------------------------------------------------------------- //

KDFT1DUnitTest::~KDFT1DUnitTest()
{}

// ---------------------------------------------------------------------------------------------------- //

void KDFT1DUnitTest::testDefaultConstructor()
{
    try
    {
        TDFT1D<klab::Real> dft;
        TEST_ASSERT(dft.shift() == false)

        TDFT1D<std::complex<klab::Real> > dftc;
...
void KDFT1DUnitTest::testShiftConstructor()
{
    try
    {
        TDFT1D<klab::Real> dft1(true);
        TEST_ASSERT(dft1.shift() == true)

        TDFT1D<klab::Real> dft2(false);
        TEST_ASSERT(dft2.shift() == false)


        TDFT1D<std::complex<klab::Real> > dft1c(true);
        TEST_ASSERT(dft1c.shift() == true)

        TDFT1D<std::complex<klab::Real> > dft2c(false);
...
void KDFT1DUnitTest::testCopyConstructor()
{
    try
    {
        TDFT1D<klab::Real> dft1;
        TEST_ASSERT(dft1.shift() == false)

        TDFT1D<klab::Real> dft2(dft1);
        TEST_ASSERT(dft2.shift() == false)

        TDFT1D<klab::Real> dft3(true);
        TEST_ASSERT(dft3.shift() == true)

        TDFT1D<klab::Real> dft4(dft3);
        TEST_ASSERT(dft4.shift() == true)


        TDFT1D<std::complex<klab::Real> > dft1c;
        TEST_ASSERT(dft1c.shift() == false)

        TDFT1D<std::complex<klab::Real> > dft2c(dft1c);
        TEST_ASSERT(dft2c.shift() == false)

        TDFT1D<std::complex<klab::Real> > dft3c(true);
        TEST_ASSERT(dft3c.shift() == true)

        TDFT1D<std::complex<klab::Real> > dft4c(dft3c);
...
void KDFT1DUnitTest::testAffectationOperator()
{
    try
    {
        TDFT1D<klab::Real> dft1;
        ...
        TDFT1D<std::complex<klab::Real> > dft2c;
        dft2c = dft1c;
        TEST_ASSERT(dft2c.shift() == false)
        ...
        TDFT1D<std::complex<klab::Real> > dft4c;
        dft4c = dft3c;
        TEST_ASSERT(dft4c.shift() == true)
    }
    catch(...)
...
void KDFT1DUnitTest::testSetShift()
{
    try
    {
        TDFT1D<klab::Real> dft;
...
void KDFT1DUnitTest::testTransform()
{
    try
    {
        ...
        TDFT1D<std::complex<klab::DoubleReal> > dft;
        dft.transform(f, F);
        ...
        TDFT1D<std::complex<klab::DoubleReal> > dft2(true);
        dft2.transform(f, F);
        ...
        TDFT1D<std::complex<klab::DoubleReal> > dft0;
        dft0.transform(f0, F0);
        TEST_ASSERT(f0.n_rows == 0)
        TEST_ASSERT(F0.n_rows == 0)

        TDFT1D<std::complex<klab::DoubleReal> > dft00(true);
...
void KDFT1DUnitTest::testTransform_Real()
{
    try
    {
        ...
        TDFT1D<klab::DoubleReal> dft2(true);
        dft2.transform(f, F);
        ...
        TDFT1D<klab::DoubleReal> dft0;
        dft0.transform(f0, F0);
        TEST_ASSERT(f0.n_rows == 0)
        TEST_ASSERT(F0.n_rows == 0)

        TDFT1D<klab::DoubleReal> dft00(true);
        dft00.transform(f0, F0);
        TEST_ASSERT(f0.n_rows == 0)
        TEST_ASSERT(F0.n_rows == 0)
...
void KDFT1DUnitTest::testTransform_02()
{
    try
    {
...
void KDFT1DUnitTest::testTransform_02_Real()
{
    try
    {
...
void KDFT1DUnitTest::testInvert()
{
    try
    {
        arma::Col<std::complex<klab::DoubleReal> > f(32);
...
void KDFT1DUnitTest::testInvert_Real()
{
    try
    {
        arma::Col<klab::DoubleReal> f(32);
...
void KDFT1DUnitTest::testInvert_02()
{
    try
    {
        arma::Col<std::complex<klab::DoubleReal> > f(33);
...
void KDFT1DUnitTest::testInvert_02_Real()
{
    try
    {
        arma::Col<klab::DoubleReal> f(33);
