...
#ifndef KLAB_FWT2DUNITTEST_H
#define KLAB_FWT2DUNITTEST_H
...
class KFWT2DUnitTest : public Test::Suite
{
public:
    
    KFWT2DUnitTest();
    virtual ~KFWT2DUnitTest();
...
private:
    ...
    KFWT2DUnitTest(const KFWT2DUnitTest& test);
    KFWT2DUnitTest&     operator=(const KFWT2DUnitTest& test);
};
