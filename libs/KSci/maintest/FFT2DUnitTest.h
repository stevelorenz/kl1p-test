...
#ifndef KLAB_FFT2DUNITTEST_H
#define KLAB_FFT2DUNITTEST_H
...
class KFFT2DUnitTest : public Test::Suite
{
public:
    
    KFFT2DUnitTest();
    virtual ~KFFT2DUnitTest();
...
private:
    ...
    KFFT2DUnitTest(const KFFT2DUnitTest& test);
    KFFT2DUnitTest&     operator=(const KFFT2DUnitTest& test);
};
