...
#include "../include/DWT1D.h"
#include "../include/HaarWaveletFilter.h"
#include "../include/DaubechiesWaveletFilter.h"
#include "../include/BiorthogonalDaubechiesWaveletFilter.h"
...
KDWT1DUnitTest::KDWT1DUnitTest() : Test::Suite()
{
    TEST_ADD(KDWT1DUnitTest::testDefaultConstructor)  
    TEST_ADD(KDWT1DUnitTest::testFilterConstructor)
    TEST_ADD(KDWT1DUnitTest::testCopyConstructor)
    TEST_ADD(KDWT1DUnitTest::testAffectationOperator)

    TEST_ADD(KDWT1DUnitTest::testFilter)
    TEST_ADD(KDWT1DUnitTest::testTransform)
    TEST_ADD(KDWT1DUnitTest::testInvert)   

    TEST_ADD(KDWT1DUnitTest::testHaarWavelet)
    TEST_ADD(KDWT1DUnitTest::testDaubechies2Wavelet) 
    TEST_ADD(KDWT1DUnitTest::testDaubechies4Wavelet) 
    TEST_ADD(KDWT1DUnitTest::testDaubechies6Wavelet)
    TEST_ADD(KDWT1DUnitTest::testDaubechies8Wavelet)
    TEST_ADD(KDWT1DUnitTest::testDaubechies10Wavelet)
    TEST_ADD(KDWT1DUnitTest::testDaubechies9_7Wavelet)
    TEST_ADD(KDWT1DUnitTest::testDelegateWavelet)
    TEST_ADD(KDWT1DUnitTest::testNameWavelet)
    TEST_ADD(KDWT1DUnitTest::testCustomWavelet)
}

// ---------------------------------------------------------------------------------------------------- //

KDWT1DUnitTest::~KDWT1DUnitTest()
{}

// ---------------------------------------------------------------------------------------------------- //

void KDWT1DUnitTest::testDefaultConstructor()
{
    try
    {
        TDWT1D<klab::DoubleReal> dwt;
...
void KDWT1DUnitTest::testFilterConstructor()
{
    try
    {
        THaarWaveletFilter<klab::DoubleReal> filter;

        TDWT1D<klab::DoubleReal, THaarWaveletFilter<klab::DoubleReal> > dwt(filter);
...
void KDWT1DUnitTest::testCopyConstructor()
{
    try
    {
        TDWT1D<klab::DoubleReal> dwt;
        ...
        TDWT1D<klab::DoubleReal> dwt2(dwt);
...
void KDWT1DUnitTest::testAffectationOperator()
{
    try
    {
        TDWT1D<klab::DoubleReal> dwt;
...
void KDWT1DUnitTest::testFilter()
{
    try
    {
        TDWT1D<klab::DoubleReal> dwt;
...
void KDWT1DUnitTest::testTransform()
{
    try
    {
        klab::UInt32 n = 32;
        ...
        TDWT1D<klab::DoubleReal, THaarWaveletFilter<klab::DoubleReal> > dwt;
        ...
        // Limit cases.
        dwt.transform(arma::Col<klab::DoubleReal>(), F);
        TEST_ASSERT(F.n_rows == 0)

        try                                 {dwt.transform(arma::Col<klab::DoubleReal>(31), F); TEST_ASSERT(false)}
...
void KDWT1DUnitTest::testInvert()
{
    try
    {
        klab::UInt32 n = 32;
        ...
        // Limit cases.
        dwt.invert(arma::Col<klab::DoubleReal>(), fr);
        TEST_ASSERT(fr.n_rows == 0)

        try                                 {dwt.invert(arma::Col<klab::DoubleReal>(31), fr); TEST_ASSERT(false)}
        catch(KSizePowerOf2DWTException&)   {TEST_ASSERT(true)}
        catch(...)                          {TEST_ASSERT(false)}
...
void KDWT1DUnitTest::testHaarWavelet()
{
    try
    {
        klab::UInt32 n = 32;
...
void KDWT1DUnitTest::testDaubechies2Wavelet()
{
    try
    {
        klab::UInt32 n = 32;
        ...
        TDWT1D<klab::DoubleReal, TDaubechiesWaveletFilter<klab::DoubleReal, 2> > dwt;
        TEST_ASSERT(dwt.filter().waveLength() == 2)
...
void KDWT1DUnitTest::testDaubechies4Wavelet()
{
    try
    {
        klab::UInt32 n = 32;
        ...
        TDWT1D<klab::DoubleReal, TDaubechiesWaveletFilter<klab::DoubleReal, 4> > dwt;
...
void KDWT1DUnitTest::testDaubechies6Wavelet()
{
    try
    {
        klab::UInt32 n = 32;
        ...
        TDWT1D<klab::DoubleReal, TDaubechiesWaveletFilter<klab::DoubleReal, 6> > dwt;
...
void KDWT1DUnitTest::testDaubechies8Wavelet()
{
    try
    {
        klab::UInt32 n = 32;
        ...
        TDWT1D<klab::DoubleReal, TDaubechiesWaveletFilter<klab::DoubleReal, 8> > dwt;
...
void KDWT1DUnitTest::testDaubechies10Wavelet()
{
    try
    {
        klab::UInt32 n = 32;
        ...
        TDWT1D<klab::DoubleReal, TDaubechiesWaveletFilter<klab::DoubleReal, 10> > dwt;
...
void KDWT1DUnitTest::testDaubechies9_7Wavelet()
{
    try
    {
        klab::UInt32 n = 32; 
        ...
        TDWT1D<klab::DoubleReal, TBiorthogonalDaubechiesWaveletFilter<klab::DoubleReal, 9, 7> > dwt;
...
void KDWT1DUnitTest::testDelegateWavelet()
{
    try
    {
        klab::UInt32 n = 32;
        ...
        TDWT1D<klab::DoubleReal, TDelegateWaveletFilter<klab::DoubleReal> > dwt(new THaarWaveletFilter<klab::DoubleReal>());
        TEST_ASSERT(dwt.filter().waveLength() == 2)
...
void KDWT1DUnitTest::testNameWavelet()
{
    try
    {
        klab::UInt32 n = 32;
        ...
        TDWT1D<klab::DoubleReal, TNameWaveletFilter<klab::DoubleReal> > dwt("Haar");
        TEST_ASSERT(dwt.filter().waveLength() == 2)
...
void KDWT1DUnitTest::testCustomWavelet()
{
    try
    {
        klab::UInt32 n = 32;
        ...
        TDWT1D<klab::DoubleReal, TCustomWaveletFilter<klab::DoubleReal> > dwt(TCustomWaveletFilter<klab::DoubleReal>(haarScalingCoefficients, haarWaveletCoefficients));
        TEST_ASSERT(dwt.filter().waveLength() == 2)
