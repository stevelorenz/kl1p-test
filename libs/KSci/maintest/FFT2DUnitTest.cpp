...
KFFT2DUnitTest::KFFT2DUnitTest() : Test::Suite()
{
    TEST_ADD(KFFT2DUnitTest::testDefaultConstructor)  
    TEST_ADD(KFFT2DUnitTest::testShiftConstructor)
    TEST_ADD(KFFT2DUnitTest::testCopyConstructor)
    TEST_ADD(KFFT2DUnitTest::testAffectationOperator)
    TEST_ADD(KFFT2DUnitTest::testSetShift)
    TEST_ADD(KFFT2DUnitTest::testShift)
    TEST_ADD(KFFT2DUnitTest::testTransform)
    TEST_ADD(KFFT2DUnitTest::testTransform_02)
    TEST_ADD(KFFT2DUnitTest::testTransform_03)
    TEST_ADD(KFFT2DUnitTest::testTransform_04)
    TEST_ADD(KFFT2DUnitTest::testInvert) 
    TEST_ADD(KFFT2DUnitTest::testInvert_Real) 
    TEST_ADD(KFFT2DUnitTest::testInvert_02)
    TEST_ADD(KFFT2DUnitTest::testInvert_02_Real)
    TEST_ADD(KFFT2DUnitTest::testInvert_03)
    TEST_ADD(KFFT2DUnitTest::testInvert_03_Real)
    TEST_ADD(KFFT2DUnitTest::testInvert_04)
    TEST_ADD(KFFT2DUnitTest::testInvert_04_Real)
}

// ---------------------------------------------------------------------------------------------------- //

KFFT2DUnitTest::~KFFT2DUnitTest()
{}

// ---------------------------------------------------------------------------------------------------- //

void KFFT2DUnitTest::testDefaultConstructor()
{
    try
    {
        TFFT2D<klab::Real> fft;
        TEST_ASSERT(fft.shift() == false)

        TFFT2D<std::complex<klab::Real> > fftc;
...
void KFFT2DUnitTest::testShiftConstructor()
{
    try
    {
        TFFT2D<klab::Real> fft1(true);
        TEST_ASSERT(fft1.shift() == true)

        TFFT2D<klab::Real> fft2(false);
        TEST_ASSERT(fft2.shift() == false)


        TFFT2D<std::complex<klab::Real> > fft1c(true);
        TEST_ASSERT(fft1c.shift() == true)

        TFFT2D<std::complex<klab::Real> > fft2c(false);
...
void KFFT2DUnitTest::testCopyConstructor()
{
    try
    {
        TFFT2D<klab::Real> fft1;
        TEST_ASSERT(fft1.shift() == false)

        TFFT2D<klab::Real> fft2(fft1);
        TEST_ASSERT(fft2.shift() == false)

        TFFT2D<klab::Real> fft3(true);
        TEST_ASSERT(fft3.shift() == true)

        TFFT2D<klab::Real> fft4(fft3);
        TEST_ASSERT(fft4.shift() == true)


        TFFT2D<std::complex<klab::Real> > fft1c;
        TEST_ASSERT(fft1c.shift() == false)

        TFFT2D<std::complex<klab::Real> > fft2c(fft1c);
        TEST_ASSERT(fft2c.shift() == false)

        TFFT2D<std::complex<klab::Real> > fft3c(true);
        TEST_ASSERT(fft3c.shift() == true)

        TFFT2D<std::complex<klab::Real> > fft4c(fft3c);
...
void KFFT2DUnitTest::testAffectationOperator()
{
    try
    {
        TFFT2D<klab::Real> fft1;
        ...
        TFFT2D<std::complex<klab::Real> > fft2c;
        fft2c = fft1c;
        TEST_ASSERT(fft2c.shift() == false)
        ...
        TFFT2D<std::complex<klab::Real> > fft4c;
        fft4c = fft3c;
        TEST_ASSERT(fft4c.shift() == true)
    }
    catch(...)
...
void KFFT2DUnitTest::testSetShift()
{
    try
    {
        TFFT2D<klab::Real> fft;
...
void KFFT2DUnitTest::testTransform()
{
    try
    {
        ...
        TFFT2D<std::complex<klab::DoubleReal> > fft2(true);
        fft2.transform(f, F);
        ...
        TFFT2D<std::complex<klab::DoubleReal> > fft0;
        fft0.transform(f0, F0);
        TEST_ASSERT(f0.n_rows==0 && f0.n_cols==0)
        TEST_ASSERT(F0.n_rows==0 && F0.n_cols==0)

        TFFT2D<std::complex<klab::DoubleReal> > fft00(true);
...
void KFFT2DUnitTest::testTransform_02()
{
    try
    {
...
void KFFT2DUnitTest::testTransform_03()
{
    try
    {
...
void KFFT2DUnitTest::testTransform_04()
{
    try
    {
...
void KFFT2DUnitTest::testInvert()
{
    try
    {
        arma::Mat<std::complex<klab::DoubleReal> > f(8, 8);
...
void KFFT2DUnitTest::testInvert_Real()
{
    try
    {
        ...
        TFFT2D<klab::DoubleReal> fft2(true);
        fft2.transform(f, F);
        fft2.invert(F, fR);
        ...
        TFFT2D<klab::DoubleReal> fft00(true);
        fft00.transform(f0, F0);
        fft00.invert(F0, fR0);
        TEST_ASSERT(f0.n_rows==0 && f0.n_cols==0)
        TEST_ASSERT(F0.n_rows==0 && F0.n_cols==0)
...
void KFFT2DUnitTest::testInvert_02()
{
    try
    {
        arma::Mat<std::complex<klab::DoubleReal> > f(9, 8);
...
void KFFT2DUnitTest::testInvert_02_Real()
{
    try
    {
...
void KFFT2DUnitTest::testInvert_03()
{
    try
    {
        arma::Mat<std::complex<klab::DoubleReal> > f(8, 9);
...
void KFFT2DUnitTest::testInvert_03_Real()
{
    try
    {
...
void KFFT2DUnitTest::testInvert_04()
{
    try
    {
        arma::Mat<std::complex<klab::DoubleReal> > f(9, 9);
...
void KFFT2DUnitTest::testInvert_04_Real()
{
    try
    {
