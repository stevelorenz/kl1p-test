...
#ifndef KL1P_ADDITIONOPERATOR_H
#define KL1P_ADDITIONOPERATOR_H
...
class TAdditionOperator : public TOperator<T, TOut>
{
public:
    
    TAdditionOperator(klab::TSmartPointer<TLeft> left, klab::TSmartPointer<TRight> right);
    TAdditionOperator(const TAdditionOperator<T, TOut, TLeft, TRight>& op);
    virtual ~TAdditionOperator();    
...
private:
    ...
    TAdditionOperator();
    TAdditionOperator<T, TOut, TLeft, TRight>&  operator=(const TAdditionOperator<T, TOut, TLeft, TRight>& op);
...
inline TAdditionOperator<T, TOut, TLeft, TRight>::TAdditionOperator(klab::TSmartPointer<TLeft> left, klab::TSmartPointer<TRight> right) : TOperator<T, TOut>(klab::Max(left!=0?left->m():0, right!=0?right->m():0), klab::Max(left!=0?left->n():0, right!=0?right->n():0)),
...
template<class T, class TOut, class TLeft, class TRight>
inline TAdditionOperator<T, TOut, TLeft, TRight>::TAdditionOperator(const TAdditionOperator<T, TOut, TLeft, TRight>& op) : TOperator<T, TOut>(op),
...
template<class T, class TOut, class TLeft, class TRight>
inline TAdditionOperator<T, TOut, TLeft, TRight>::~TAdditionOperator()
{}

// ---------------------------------------------------------------------------------------------------- //

template<class T, class TOut, class TLeft, class TRight>
inline klab::TSmartPointer<TLeft> TAdditionOperator<T, TOut, TLeft, TRight>::left() const
{
    return _left;
}
...
template<class T, class TOut, class TLeft, class TRight>
inline klab::TSmartPointer<TRight> TAdditionOperator<T, TOut, TLeft, TRight>::right() const
{
    return _right;
}
...
template<class T, class TOut, class TLeft, class TRight>
inline bool TAdditionOperator<T, TOut, TLeft, TRight>::isZero()
{
...
template<class T, class TOut, class TLeft, class TRight>
inline void TAdditionOperator<T, TOut, TLeft, TRight>::apply(const arma::Col<T>& in, arma::Col<TOut>& out)
{
...
template<class T, class TOut, class TLeft, class TRight>
inline void TAdditionOperator<T, TOut, TLeft, TRight>::applyAdjoint(const arma::Col<TOut>& in, arma::Col<T>& out)
{
    ThrowTraceExceptionIf(KNullOperatorException, _left==0 && _right==0);
...
template<class T, class TOut, class TLeft, class TRight>
inline void TAdditionOperator<T, TOut, TLeft, TRight>::column(klab::UInt32 i, arma::Col<TOut>& out)
{
    ThrowTraceExceptionIf(KNullOperatorException, _left==0 && _right==0);
...
template<class T, class TOut, class TLeft, class TRight>
inline void TAdditionOperator<T, TOut, TLeft, TRight>::columnAdjoint(klab::UInt32 i, arma::Col<T>& out)
{
    ThrowTraceExceptionIf(KNullOperatorException, _left==0 && _right==0);
...
{
    return new TAdditionOperator<T, TOut, TOperator<T, TOut>, TOperator<T, TOut> >(left, right);
}
