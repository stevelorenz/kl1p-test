...
#ifndef KL1P_WAVELET1DOPERATORUNITTEST_H
#define KL1P_WAVELET1DOPERATORUNITTEST_H
...
class KWavelet1DOperatorUnitTest : public Test::Suite
{
public:
    
    KWavelet1DOperatorUnitTest();
    virtual ~KWavelet1DOperatorUnitTest();
...
private:
    ...
    KWavelet1DOperatorUnitTest(const KWavelet1DOperatorUnitTest& test);
    KWavelet1DOperatorUnitTest&     operator=(const KWavelet1DOperatorUnitTest& test);
};
