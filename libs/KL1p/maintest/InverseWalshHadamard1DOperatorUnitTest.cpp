...
#include "../include/InverseWalshHadamard1DOperator.h"
...
KInverseWalshHadamard1DOperatorUnitTest::KInverseWalshHadamard1DOperatorUnitTest() : Test::Suite()
{
    TEST_ADD(KInverseWalshHadamard1DOperatorUnitTest::testNConstructor)  
    TEST_ADD(KInverseWalshHadamard1DOperatorUnitTest::testCopyConstructor)

    TEST_ADD(KInverseWalshHadamard1DOperatorUnitTest::testApply)
    TEST_ADD(KInverseWalshHadamard1DOperatorUnitTest::testApply_Complex)
    TEST_ADD(KInverseWalshHadamard1DOperatorUnitTest::testApplyAdjoint)
    TEST_ADD(KInverseWalshHadamard1DOperatorUnitTest::testApplyAdjoint_Complex)
}

// ---------------------------------------------------------------------------------------------------- //

KInverseWalshHadamard1DOperatorUnitTest::~KInverseWalshHadamard1DOperatorUnitTest()
{}

// ---------------------------------------------------------------------------------------------------- //

void KInverseWalshHadamard1DOperatorUnitTest::testNConstructor()
{
    try
    {
        TInverseWalshHadamard1DOperator<klab::DoubleReal> op1(16);
        TEST_ASSERT(op1.m()==16 && op1.n()==16)

        TInverseWalshHadamard1DOperator<std::complex<klab::DoubleReal> > op2(16);
...
void KInverseWalshHadamard1DOperatorUnitTest::testCopyConstructor()
{
    try
    {
        TInverseWalshHadamard1DOperator<klab::DoubleReal> op1(16);
        TInverseWalshHadamard1DOperator<klab::DoubleReal> op1Copy(op1);
        TEST_ASSERT(op1Copy.m()==16 && op1Copy.n()==16)

        TInverseWalshHadamard1DOperator<std::complex<klab::DoubleReal> > op2(16);
        TInverseWalshHadamard1DOperator<std::complex<klab::DoubleReal> > op2Copy(op2);
...
void KInverseWalshHadamard1DOperatorUnitTest::testApply()
{
    try
    {
        ...
        TInverseWalshHadamard1DOperator<klab::DoubleReal> op(8);
        op.apply(x, y);

        TEST_ASSERT(y.n_rows == 8)
        TEST_ASSERT(klab::Equals(y[0], 1.0, precision))
        TEST_ASSERT(klab::Equals(y[1], 2.0, precision))
        TEST_ASSERT(klab::Equals(y[2], 3.0, precision))
        TEST_ASSERT(klab::Equals(y[3], 4.0, precision))
        TEST_ASSERT(klab::Equals(y[4], 5.0, precision))
        TEST_ASSERT(klab::Equals(y[5], 6.0, precision))
        TEST_ASSERT(klab::Equals(y[6], 7.0, precision))
        TEST_ASSERT(klab::Equals(y[7], 8.0, precision))
    }
    catch(...)
    {
        TEST_ASSERT(false)
...
void KInverseWalshHadamard1DOperatorUnitTest::testApply_Complex()
{
    try
    {
        klab::DoubleReal precision = 1e-12;
        ...
        x[2] = std::complex<klab::DoubleReal>(-8.0, 0.0);
        x[3] = std::complex<klab::DoubleReal>( 0.0, 0.0);
        x[4] = std::complex<klab::DoubleReal>(-16.0, 0.0);
        x[5] = std::complex<klab::DoubleReal>( 0.0, 0.0);
        x[6] = std::complex<klab::DoubleReal>( 0.0, 0.0);
        x[7] = std::complex<klab::DoubleReal>( 0.0, 0.0);


        TInverseWalshHadamard1DOperator<std::complex<klab::DoubleReal> > op(8);
        op.apply(x, y);
...
void KInverseWalshHadamard1DOperatorUnitTest::testApplyAdjoint()
{
    try
    {
        klab::DoubleReal precision = 1e-12;
...
void KInverseWalshHadamard1DOperatorUnitTest::testApplyAdjoint_Complex()
{
    try
    {
        klab::DoubleReal precision = 1e-12;
