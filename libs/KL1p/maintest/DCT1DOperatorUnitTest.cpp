...
#include "../include/DCT1DOperator.h"
...
KDCT1DOperatorUnitTest::KDCT1DOperatorUnitTest() : Test::Suite()
{ 
    TEST_ADD(KDCT1DOperatorUnitTest::testNConstructor)  
    TEST_ADD(KDCT1DOperatorUnitTest::testCopyConstructor)

    TEST_ADD(KDCT1DOperatorUnitTest::testApply)
    TEST_ADD(KDCT1DOperatorUnitTest::testApply_Complex)
    TEST_ADD(KDCT1DOperatorUnitTest::testApplyAdjoint)
    TEST_ADD(KDCT1DOperatorUnitTest::testApplyAdjoint_Complex)
}

// ---------------------------------------------------------------------------------------------------- //

KDCT1DOperatorUnitTest::~KDCT1DOperatorUnitTest()
{}

// ---------------------------------------------------------------------------------------------------- //

void KDCT1DOperatorUnitTest::testNConstructor()
{
    try
    {
        TDCT1DOperator<klab::DoubleReal> op1(128);
        TEST_ASSERT(op1.m()==128 && op1.n()==128)

        TDCT1DOperator<std::complex<klab::DoubleReal> > op2(128);
...
void KDCT1DOperatorUnitTest::testCopyConstructor()
{
    try
    {
        TDCT1DOperator<klab::DoubleReal> op1(128);
        TDCT1DOperator<klab::DoubleReal> op1Copy(op1);
        TEST_ASSERT(op1Copy.m()==128 && op1Copy.n()==128)

        TDCT1DOperator<std::complex<klab::DoubleReal> > op2(128);
        TDCT1DOperator<std::complex<klab::DoubleReal> > op2Copy(op2);
...
void KDCT1DOperatorUnitTest::testApply()
{
    try
    {
        ...
        TDCT1DOperator<klab::DoubleReal> op(8);
        op.apply(x, y);

        TEST_ASSERT(y.n_rows == 8)
        TEST_ASSERT(klab::Equals(y[0],  12.727922061357855, precision))
        TEST_ASSERT(klab::Equals(y[1], -6.4423230227051373, precision))
        TEST_ASSERT(klab::Equals(y[2],  0.0, precision))
        TEST_ASSERT(klab::Equals(y[3], -0.67345480090394072, precision))
        TEST_ASSERT(klab::Equals(y[4],  0.0, precision))
        TEST_ASSERT(klab::Equals(y[5], -0.20090290373599659, precision))
        TEST_ASSERT(klab::Equals(y[6],  0.0, precision))
        TEST_ASSERT(klab::Equals(y[7], -0.050702322759646368, precision))
    }
    catch(...)
    {
        TEST_ASSERT(false)
...
void KDCT1DOperatorUnitTest::testApply_Complex()
{
    try
    {
        klab::DoubleReal precision = 1e-12;
        ...
        TDCT1DOperator<std::complex<klab::DoubleReal> > op(8);
        op.apply(x, y);

        TEST_ASSERT(y.n_rows == 8)
        TEST_ASSERT(klab::Equals(y[0], std::complex<klab::DoubleReal>( 12.727922061357855, 0.0), precision))
        TEST_ASSERT(klab::Equals(y[1], std::complex<klab::DoubleReal>(-6.4423230227051373, 0.0), precision))
        TEST_ASSERT(klab::Equals(y[2], std::complex<klab::DoubleReal>( 0.0, 0.0), precision))
        TEST_ASSERT(klab::Equals(y[3], std::complex<klab::DoubleReal>(-0.67345480090394072, 0.0), precision))
        TEST_ASSERT(klab::Equals(y[4], std::complex<klab::DoubleReal>( 0.0, 0.0), precision))
        TEST_ASSERT(klab::Equals(y[5], std::complex<klab::DoubleReal>(-0.20090290373599659, 0.0), precision))
        TEST_ASSERT(klab::Equals(y[6], std::complex<klab::DoubleReal>( 0.0, 0.0), precision))
        TEST_ASSERT(klab::Equals(y[7], std::complex<klab::DoubleReal>(-0.050702322759646368, 0.0), precision))
    }
    catch(...)
    {
        TEST_ASSERT(false)
...
void KDCT1DOperatorUnitTest::testApplyAdjoint()
{
    try
    {
        klab::DoubleReal precision = 1e-12;
        ...
        arma::Mat<klab::DoubleReal> dctMatrix(8, 8);
        ...
        arma::Col<klab::DoubleReal> xt = arma::trans(dctMatrix) * x;
...
void KDCT1DOperatorUnitTest::testApplyAdjoint_Complex()
{
    try
    {
        klab::DoubleReal precision = 1e-12;
        ...
        arma::Mat<std::complex<klab::DoubleReal> > dctMatrix(8, 8);
        for(klab::UInt32 j=0; j<8; ++j)
        {
        ...
        arma::Col<std::complex<klab::DoubleReal> > xt = arma::trans(dctMatrix) * x;
