...
#ifndef KL1P_INVERSEWAVELET2DOPERATORUNITTEST_H
#define KL1P_INVERSEWAVELET2DOPERATORUNITTEST_H
...
class KInverseWavelet2DOperatorUnitTest : public Test::Suite
{
public:
    
    KInverseWavelet2DOperatorUnitTest();
    virtual ~KInverseWavelet2DOperatorUnitTest();
...
private:
    ...
    KInverseWavelet2DOperatorUnitTest(const KInverseWavelet2DOperatorUnitTest& test);
    KInverseWavelet2DOperatorUnitTest&     operator=(const KInverseWavelet2DOperatorUnitTest& test);
};
