...
#include "../include/InverseDCT2DOperator.h"
...
KInverseDCT2DOperatorUnitTest::KInverseDCT2DOperatorUnitTest() : Test::Suite()
{
    TEST_ADD(KInverseDCT2DOperatorUnitTest::testHeightWidthConstructor) 
    TEST_ADD(KInverseDCT2DOperatorUnitTest::testCopyConstructor)

    TEST_ADD(KInverseDCT2DOperatorUnitTest::testWidth) 
    TEST_ADD(KInverseDCT2DOperatorUnitTest::testHeight) 
    TEST_ADD(KInverseDCT2DOperatorUnitTest::testApply)
    TEST_ADD(KInverseDCT2DOperatorUnitTest::testApply_Complex)
    TEST_ADD(KInverseDCT2DOperatorUnitTest::testApplyAdjoint)
    TEST_ADD(KInverseDCT2DOperatorUnitTest::testApplyAdjoint_Complex)
}

// ---------------------------------------------------------------------------------------------------- //

KInverseDCT2DOperatorUnitTest::~KInverseDCT2DOperatorUnitTest()
{}

// ---------------------------------------------------------------------------------------------------- //

void KInverseDCT2DOperatorUnitTest::testHeightWidthConstructor()
{
    try
    {
        TInverseDCT2DOperator<klab::DoubleReal> op1(32, 64);
        TEST_ASSERT(op1.m()==2048 && op1.n()==2048)
        TEST_ASSERT(op1.height()==32 && op1.width()==64)

        TInverseDCT2DOperator<std::complex<klab::DoubleReal> > op2(64, 32);
...
void KInverseDCT2DOperatorUnitTest::testCopyConstructor()
{
    try
    {
        TInverseDCT2DOperator<klab::DoubleReal> op1(32, 64);
        TInverseDCT2DOperator<klab::DoubleReal> op1Copy(op1);
        TEST_ASSERT(op1Copy.m()==2048 && op1Copy.n()==2048)
        TEST_ASSERT(op1Copy.height()==32 && op1Copy.width()==64)

        TInverseDCT2DOperator<std::complex<klab::DoubleReal> > op2(64, 32);
        TInverseDCT2DOperator<std::complex<klab::DoubleReal> > op2Copy(op2);
...
void KInverseDCT2DOperatorUnitTest::testWidth()
{
    try
    {
        TInverseDCT2DOperator<klab::DoubleReal> op1(0, 0);
        TEST_ASSERT(op1.height()==0 && op1.width()==0)

        TInverseDCT2DOperator<klab::DoubleReal> op2(32, 64);
        TEST_ASSERT(op2.height()==32 && op2.width()==64)

        TInverseDCT2DOperator<klab::DoubleReal> op3(64, 32);
        TEST_ASSERT(op3.height()==64 && op3.width()==32)


        TInverseDCT2DOperator<std::complex<klab::DoubleReal> > op4(0, 0);
        TEST_ASSERT(op4.height()==0 && op4.width()==0)

        TInverseDCT2DOperator<std::complex<klab::DoubleReal> > op5(32, 64);
        TEST_ASSERT(op5.height()==32 && op5.width()==64)

        TInverseDCT2DOperator<std::complex<klab::DoubleReal> > op6(64, 32);
...
void KInverseDCT2DOperatorUnitTest::testHeight()
{
    try
    {
        TInverseDCT2DOperator<klab::DoubleReal> op1(0, 0);
...
void KInverseDCT2DOperatorUnitTest::testApply()
{
    try
    {
        klab::UInt32 m = 8;
        ...
        TInverseDCT2DOperator<klab::DoubleReal> op(m, n);
        op.apply(x, y);
        fr = y;
        fr.reshape(8, 8);
...
void KInverseDCT2DOperatorUnitTest::testApply_Complex()
{
    try
    {
        klab::UInt32 m = 8;
        ...
        TInverseDCT2DOperator<std::complex<klab::DoubleReal> > op(m, n);
        op.apply(x, y);
        fr = y;
        fr.reshape(8, 8);
...
void KInverseDCT2DOperatorUnitTest::testApplyAdjoint()
{
    try
    {
        klab::UInt32 m = 8;
...
void KInverseDCT2DOperatorUnitTest::testApplyAdjoint_Complex()
{
    try
    {
        klab::UInt32 m = 8;
