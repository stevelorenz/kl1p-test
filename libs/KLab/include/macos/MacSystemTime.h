...
#ifndef KLAB_MACSYSTEMTIME_H
#define KLAB_MACSYSTEMTIME_H
...
protected:
    ...
    TSystemTime();
    TSystemTime(const TSystemTime<MacOSSystem>& system);
    TSystemTime<MacOSSystem>&	operator=(const TSystemTime<MacOSSystem>& system);
};

// ---------------------------------------------------------------------------------------------------- //

inline TSystemTime<MacOSSystem>::TSystemTime()
{}

// ---------------------------------------------------------------------------------------------------- //

inline TSystemTime<MacOSSystem>::TSystemTime(const TSystemTime<MacOSSystem>& system)
{}
...
inline TSystemTime<MacOSSystem>& TSystemTime<MacOSSystem>::operator=(const TSystemTime<MacOSSystem>& system)
{
    return *this;
}
...
inline KMicrosecTime TSystemTime<MacOSSystem>::GetTickCount()
{ 
    timeval tv;
	::gettimeofday(&tv, 0); 
...
inline KTimestamp TSystemTime<MacOSSystem>::GetCurrentTimestamp()
{
    return static_cast<KTimestamp>(TSystemTime<MacOSSystem>::GetCurrentMicrosecTimestamp()/1000000);
}

// ---------------------------------------------------------------------------------------------------- //

inline KMillisecTimestamp TSystemTime<MacOSSystem>::GetCurrentMillisecTimestamp()
{
    return static_cast<KTimestamp>(TSystemTime<MacOSSystem>::GetCurrentMicrosecTimestamp()/1000);
}

// ---------------------------------------------------------------------------------------------------- //

inline KMicrosecTimestamp TSystemTime<MacOSSystem>::GetCurrentMicrosecTimestamp()
{ 
	timeval tv;
	::gettimeofday(&tv, 0); 
...
inline void TSystemTime<MacOSSystem>::ConvertTimestampToDateTime(const KTimestamp& timestamp, bool local, klab::UInt16& year, klab::UInt8& month, klab::UInt8& day, klab::UInt8& hour, klab::UInt8& minute, klab::UInt8& second)
{
...
inline void TSystemTime<MacOSSystem>::ConvertMillisecTimestampToDateTime(KMillisecTimestamp timestamp, bool local, klab::UInt16& year, klab::UInt8& month, klab::UInt8& day, klab::UInt8& hour, klab::UInt8& minute, klab::UInt8& second, klab::UInt16& millisec)
{
    ThrowTraceExceptionIf(KSystemTimeException, timestamp<0);   // This implementation does not support pre-epoch timestamps.  
...
inline void TSystemTime<MacOSSystem>::ConvertMicrosecTimestampToDateTime(KMicrosecTimestamp timestamp, bool local, klab::UInt16& year, klab::UInt8& month, klab::UInt8& day, klab::UInt8& hour, klab::UInt8& minute, klab::UInt8& second, klab::UInt16& millisec, klab::UInt16& microsec)
{
    ThrowTraceExceptionIf(KSystemTimeException, timestamp<0);   // This implementation does not support pre-epoch timestamps.  
...
inline klab::UInt8 TSystemTime<MacOSSystem>::GetWeekDayFromDate(klab::UInt16 year, klab::UInt8 month, klab::UInt8 day)
{
    if(TSystemTime<MacOSSystem>::IsValidDateTime(year, month, day))
    {
        tm time;
...
inline bool TSystemTime<MacOSSystem>::IsValidDateTime(klab::UInt16 year, klab::UInt8 month, klab::UInt8 day, klab::UInt8 hour, klab::UInt8 minute, klab::UInt8 second, klab::UInt16 millisec, klab::UInt16 microsec)
{
    bool ret = true;
...
inline klab::Int64 TSystemTime<MacOSSystem>::CompareDateTimes(klab::UInt16 lyear, klab::UInt8 lmonth, klab::UInt8 lday, klab::UInt8 lhour, klab::UInt8 lminute, klab::UInt8 lsecond, klab::UInt16 lmillisec, klab::UInt16 lmicrosec, klab::UInt16 ryear, klab::UInt8 rmonth, klab::UInt8 rday, klab::UInt8 rhour, klab::UInt8 rminute, klab::UInt8 rsecond, klab::UInt16 rmillisec, klab::UInt16 rmicrosec)
{
    tm ltime;
